...
void Corneria_CarrierLeft_Update(CarrierLeft*);
void Corneria_CarrierUpper_Update(CarrierUpper*);
void Corneria_CarrierBottom_Update(CarrierBottom*);
void Corneria_Carrier_Draw(Carrier*);
void Corneria_CarrierLeft_Draw(CarrierLeft*);
void Corneria_CarrierUpper_Draw(CarrierUpper*);
void Corneria_CarrierBottom_Draw(CarrierBottom*);
