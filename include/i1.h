...
void Corneria_CoRobot1_Update(CoRobot1*);
void Corneria_CoRobot2_Update(CoRobot2*);
void Corneria_CoRobot3_Update(CoRobot3*);
void Corneria_CoRobot4_Update(CoRobot4*);
void Corneria_CoRobot1_Draw(CoRobot1*);
void Corneria_CoRobot2_Draw(CoRobot2*);
void Corneria_CoRobot3_Draw(CoRobot3*);
void Corneria_CoRobot4_Draw(CoRobot4*);
