...
void PlayerShot_EffectExplosionMark_Spawn(f32, f32, f32, f32, f32, f32, f32, f32, f32, s32, s32);
...
void Effect_ExplosionMark_Draw(EffectExplosionMark*);
void Effect_LaserMark_Draw(EffectLaserMark*);
...
void Effect_EffectGrangaPlasmaShot_Draw(EffectGrangaPlasmaShot*);
...
void Effect_BossExplosion_Update(EffectBossExplosion*);
void Effect_BossExplosion_Draw(EffectBossExplosion*);
...
void Effect_TiDust_Spawn(f32 xPos, f32 yPos, f32 zPos, f32 scale1, u8 alpha, u8, u16);
void Effect_TiDust_Update(EffectTiDust*);
void Effect_TiDust_Draw(EffectTiDust*);
...
void Effect_ElectricArc2_Update(EffectElectricArc2*);
...
void Effect_Smoke2_Update(EffectSmoke2*);
void Effect_Smoke2_Draw(EffectSmoke2*);
...
void Effect_ExplosionMark_Update(EffectExplosionMark*);
void Effect_LaserMark_Update(EffectLaserMark*);
void Effect_Smoke1_Update(EffectSmoke1*);
void Effect_Smoke1_Draw(EffectSmoke1*);
...
void Effect_EffectGrangaPlasmaShot_Update(EffectGrangaPlasmaShot*);
