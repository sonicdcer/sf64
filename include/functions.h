...
void Effect_WaterSpray_Draw(Effect* );
...
void Effect_ElectricArc_Draw(Effect* );
void Effect_PinkExplosion_Draw(Effect* );
void Effect_TorpedoTrail_Draw(Effect* );
...
void Effect_SmallRock_Draw(Effect* );
void Effect_Effect348_Draw(Effect* );
void Effect_BlueOrb_Draw(Effect* );
void Effect_EnemyLaser_Draw(Effect*);
void Effect_SpyborgOrb_Draw(Effect* );
void Effect_MeFireball_Draw(Effect* );
void Effect_Effect376_Draw(Effect* );
void Effect_Sparkle_Spawn(f32 xPos, f32 yPos, f32 zPos, f32 scale2);
void Effect_Sparkle_Update(Effect* );
void Effect_Sparkle_Draw(Effect* );
...
void Effect_TimedSfx_Setup(Effect* , Vec3f* pos, u32 sfxId);
...
void Effect_WaterSpray_Update(Effect*);
...
void Effect_ElectricArc_Update(Effect*);
void Effect_PinkExplosion_Update(Effect*);
...
void Effect_FireSmoke1_Update(Effect*);
void Effect_FireSmoke_Draw(Effect*);
void Effect_FireSmoke2_Update(Effect*);
void Effect_FireSmoke3_Update(Effect*);
...
void Effect_FlamePillar_Update(Effect*);
void Effect_FlamePillar_Draw(Effect*);
...
void Effect_TorpedoTrail_Update(Effect*);
...
void Effect_SmallRock_Update(Effect*);
...
void Effect_BlueOrb_Update(Effect*);
void Effect_SpyborgOrb_Update(Effect*);
void Effect_MeFireball_Update(Effect*);
...
void Effect_OrbRing_Setup(Effect* this, f32 xPos, f32 yPos, f32 zPos, f32 xVel, f32 yVel, f32 zVel, f32 arg7, s32 alpha);
void func_effect_80083D2C(f32 xPos, f32 yPos, f32 zPos, f32 srcZ);
void Effect_OrbRing_Update(Effect*);
void Effect_OrbRing_Draw(Effect*);
