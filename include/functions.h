...
void Effect_EffectBossExplosion_Update(EffectBossExplosion* );
void Effect_EffectBossExplosion_Draw(EffectBossExplosion* );
...
void Effect_EffectTiDust_Spawn(f32 xPos, f32 yPos, f32 zPos, f32 scale1, u8 alpha, u8, u16);
void Effect_EffectTiDust_Update(EffectTiDust*);
void Effect_EffectTiDust_Draw(EffectTiDust*);
