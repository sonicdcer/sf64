...
static OramFieldInfo effectFields[] = {
    ...
    /* 0x44 */ STRUCT_FIELD(Effect, s16, unk_44, 0),
    ...
    /* 0x60 */ STRUCT_FIELD(Effect, Vec3f, unk_60, 0),
    /* 0x6C */ STRUCT_FIELD(Effect, f32, scale1, 0),
    /* 0x70 */ STRUCT_FIELD(Effect, f32, scale2, 0),
    /* 0x74 */ STRUCT_FIELD(Effect, uintptr_t, unk_74, 0),
...
static OramFieldInfo actorFields[] = {
    ...
    /* 0x0F4 */ STRUCT_FIELD(Actor, Vec3f, rot_0F4, 0),
...
static OramFieldInfo bossFields[] = {
    ...
    /* 0x078 */ STRUCT_FIELD(Boss, Vec3f, rot_078, 0),
