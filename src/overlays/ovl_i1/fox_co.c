...
void func_i1_80188C7C(Boss* boss) {
    ...
    if (boss->unk_044 == 0) {
        boss->unk_044++;
        boss->fwork[12] *= -0.2f;
        AUDIO_PLAY_SFX(0x19030004, boss->sfxPos, 4);
...
void func_i1_80188D50(Boss* boss) {
    ...
    if (boss->swork[36] == 0) {
        ...
        if (D_i1_801997E0 != 0) {
            ...
            boss->swork[36]++;
            D_i1_801997E0 = 20;
            AUDIO_PLAY_SFX(0x49008025, gDefaultSfxPos, 4);
    ...
    if (gPlayer[0].state_1C8 != 9) {
        ...
        if (boss->state < 5) {
            ...
            if ((boss->state != 0) && ((boss->unk_04C == 0) || (boss->unk_04C == 52))) {
                AUDIO_PLAY_SFX(0x29022019U, boss->sfxPos, 4);
            }
    ...
    switch (actor->state) {
        ...
        case 2:
            ...
            if (actor->unk_0B6 == (Animation_GetFrameCount(&D_602AA04) - actor->iwork[2])) {
                ...
                obj80->vel.y = sp48.y;
                obj80->vel.z = sp48.z;
                AUDIO_PLAY_SFX(0x2902401C, actor->sfxPos, 4);
            }
            break;
    }
    if (actor->iwork[1] == 0) {
...
void func_i1_8018BE7C(Boss* boss) {
    ...
    if (fabsf(gPlayer[0].unk_0AC) < 1.0f) {
        ...
        AUDIO_PLAY_SFX(0x31038018, boss->sfxPos, 4);
        D_i1_8019B6D0 = 0;
    } else {
        D_i1_8019B6D0 = 1;
...
void func_i1_8018C19C(Boss* boss) {
    ...
    if (D_i1_8019B6D0 == 0) {
        ...
        switch (boss->state) {
            ...
            case 3:
                ...
                if (boss->timer_050 == 0) {
                    ...
                    boss->timer_050 = 60;
                    boss->fwork[8] = 0.0f;
                    AUDIO_PLAY_SFX(0x2940201A, boss->sfxPos, 4);
                }
                break;
            case 4:
            ...
            case 5:
                ...
                if ((boss->fwork[0] > 60.0f) && (gBosses[2].state == 0) && (boss->swork[1] == 0)) {
                    ...
                    AUDIO_PLAY_SFX(0x2903201B, boss->sfxPos, 4);
            ...
            case 7:
                ...
                if (boss->timer_058 == 0) {
                    ...
                    if ((boss->swork[3] != 1) || (boss->swork[3] != 3)) {
                        Audio_KillSfxBySourceAndId(boss->sfxPos, 0x31034025);
                        boss->swork[9] = 0;
                    }
                }
                ...
                if ((boss->swork[3] == 0) || (boss->swork[3] == 2)) {
                    ...
                    if ((boss->obj.rot.y < 20.0f) && (boss->obj.rot.y > -20.0f)) {
                        if (boss->swork[9] == 0) {
                            boss->swork[9]++;
                            AUDIO_PLAY_SFX(0x31034025, boss->sfxPos, 4);
                            if (boss->swork[6] == 0) {
        ...
        if ((boss->swork[10] == 0) && (boss->state < 6)) {
            boss->fwork[17] = 1.8f;
            AUDIO_PLAY_SFX(0x11020084, boss->sfxPos, 4);
            boss->timer_058 = 71;
            boss->state = 6;
            boss->fwork[12] = 0.0f;
            boss->fwork[8] = 0.0f;
                    ...
                    if (boss->fwork[2] > 60.0f) {
                        if (boss->health != 0) {
                            ...
                            if (boss->health <= 0) {
                                ...
                                AUDIO_PLAY_SFX(0x2940C027, boss->sfxPos, 4);
        ...
        case 1:
            ...
            if (boss->obj.pos.y < (gGroundLevel + 150.0f)) {
                if (boss->swork[0] == 0) {
                    ...
                    boss->gravity = 0.0f;
                    func_i1_8018C0B0(boss);
                    AUDIO_PLAY_SFX(0x19000014, boss->sfxPos, 4);
                }
            } else {
                boss->obj.rot.z -= 2.0f;
                boss->gravity = 1.0f;
            ...
            if (obj80->dmgType != 0) {
                ...
                if (obj80->dmgPart < 2) {
                    ...
                    if (obj80->unk_44 >= 3) {
                        ...
                        AUDIO_PLAY_SFX(0x1900000D, obj80->sfxPos, 0);
                        return;
                    }
                    AUDIO_PLAY_SFX(0x2903300E, obj80->sfxPos, 0);
                }
            }
            break;
        case 1:
    ...
    switch (gCsFrameCount) {
        ...
        case 1150:
            if (gTeamShields[1] > 0) {
                ...
                AUDIO_PLAY_SFX(0x09000002, gActors[0].sfxPos, 0);
        ...
        case 1190:
            if (gTeamShields[2] > 0) {
                ...
                AUDIO_PLAY_SFX(0x09000002, gActors[1].sfxPos, 0);
        ...
        case 1230:
            if (gTeamShields[3] > 0) {
                ...
                AUDIO_PLAY_SFX(0x09000002, gActors[2].sfxPos, 0);
