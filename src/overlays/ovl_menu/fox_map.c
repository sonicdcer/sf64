    ...
    switch (D_menu_801CD948) {
        ...
        case 1:
            if (D_menu_801CD95C == 0) {
                if (sCurrentPlanetId == PLANET_CORNERIA) {
                    D_80178340 = 0;
                    D_menu_801CD948 = 10;
                    AUDIO_PLAY_SFX(0x0940A00BU, gDefaultSfxPos, 4U);
                } else {
                    AUDIO_PLAY_SFX(0x19003012U, gDefaultSfxPos, 4U);
                    D_menu_801CD948++;
                }
            } else {
                if (sCurrentPlanetId == PLANET_CORNERIA) {
        ...
        case 2:
            ...
            if ((D_menu_801CD9FC == D_menu_801CDA50.z) && (D_menu_801CD9D8 == 0)) {
                AUDIO_PLAY_SFX(0x19004013U, gDefaultSfxPos, 4U);
                D_menu_801CD9D8 = 1;
                if (sCurrentPlanetId == PLANET_CORNERIA) {
...
void func_menu_801A2674(void) {
    ...
    Audio_QueueSeqCmd(0x102D00FF);
    Audio_QueueSeqCmd(0x112D00FF);
}
...
void func_menu_801A2EB8(void) {
    ...
    if (D_menu_801CD9C4 == 30) {
        if (D_menu_801CD93C == 2) {
            AUDIO_PLAY_SFX(0x0900802AU, gDefaultSfxPos, 4U);
        } else {
            AUDIO_PLAY_SFX(0x09000032U, gDefaultSfxPos, 4U);
        }
    }
...
#undef PLANET_ID
    ...
    if ((D_menu_801CEED8 == 4) && (D_menu_801CEEDC == 0.0f)) {
        AUDIO_PLAY_SFX(0x19000026U, gDefaultSfxPos, 4U);
    }
...
void func_menu_801A36A8(void) {
    ...
    if (gControllerPress[gMainController].button & (A_BUTTON | START_BUTTON)) {
        AUDIO_PLAY_SFX(0x49000003U, gDefaultSfxPos, 4U);
        D_menu_801CD948 = 3;
    }
}
...
bool func_menu_801A5770(void) {
    ...
    if (ret) {
        AUDIO_PLAY_SFX(0x49000002, gDefaultSfxPos, 4);
    }
...
void func_menu_801A5E80(void) {
    switch (D_menu_801B8280) {
        ...
        case 4:
            if (D_menu_801CD9B8 == 0) {
                AUDIO_PLAY_SFX(0x49002016U, gDefaultSfxPos, 4U);
                D_menu_801CD9B8 = 75;
                D_menu_801B8280++;
            }
            break;
        ...
        switch (D_menu_801CD990) {
            ...
            case 1:
                ...
                if (D_menu_801CD998 == 8) {
                    AUDIO_PLAY_SFX(0x49008030U, gDefaultSfxPos, 4U);
                }
    ...
    switch (D_menu_801CF018) {
        ...
        case 1:
            ...
            if (D_menu_801CEA74 > 255) {
                ...
                AUDIO_PLAY_SFX(0x4100001EU, gDefaultSfxPos, 4U);
                Audio_PlayVoice(Message_IdFromPtr(D_80178308));
...
void func_menu_801AC9A0(s32 index) {
    ...
    switch (D_80177BD8[index]) {
        case 1:
            AUDIO_PLAY_SFX(0x1900404DU, gDefaultSfxPos, 4U);
            D_80177BD8[index] = 11;
            break;
...
void func_menu_801AD11C(void) {
    ...
    if (gControllerPress[gMainController].button & START_BUTTON) {
        if (D_menu_801CD944 == 3 && D_80161A34 == 7) {
            if (D_menu_801CEFD0) {
                AUDIO_PLAY_SFX(0x4900100AU, gDefaultSfxPos, 4U);
            } else {
                func_8001D6DC(1);
                D_menu_801CEFC4 = 1;
                D_menu_801CEFD4 = 0;
    ...
    if (D_menu_801CF010 == 0 && var_t0 == 1) {
        AUDIO_PLAY_SFX(0x1100004CU, gDefaultSfxPos, 4U);
        D_menu_801CF010 = 1;
    }
