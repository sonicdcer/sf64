...
s32 pad_D_menu_801AD9F0[4] = { 0, 0, 0, 0 };
    ...
    switch (D_menu_801B82C0) {
        ...
        case 10:
            ...
            if (D_menu_801B82B8 == 638) {
                Audio_PlaySfx(0x11030010, &D_menu_801B867C, 0, &D_800C5D34, &D_800C5D34, &D_800C5D3C);
                Audio_PlaySfx(0x31024059, &D_menu_801B867C, 0, &D_800C5D34, &D_800C5D34, &D_800C5D3C);
            ...
            if (D_80178340 == 255) {
                func_8001A55C(&D_menu_801B867C, 0x11030010);
                func_8001A55C(&D_menu_801B867C, 0x31024059);
...
void func_menu_8018A644(void) {
    ...
    switch (D_menu_801B82C0) {
        case 0:
            ...
            Audio_PlaySfx(0x0140001C, (Vec3f*) &D_menu_801B84D8, 0, &D_800C5D34, &D_800C5D34, &D_800C5D3C);
...
void func_menu_8018F8E4(void) {
    ...
    if (gControllerLock == 0) {
        ...
        if (gMainController < 0) {
            ...
            TextureRect_8bCI(&gMasterDisp, &D_601D750, &D_601DB50, 32, 32, D_menu_801AE464, D_menu_801AE468,
            ...
            for (i = 0; i < 6; i++) {
                TextureRect_8bIA(&gMasterDisp, D_60123F0 + (704 * i), 176, 4, D_menu_801AE474,
...
void func_menu_80190C9C(void) {
    ...
    switch (D_menu_801B7BF0) {
        ...
        case 1:
            RCP_SetupDL(&gMasterDisp, 0x53);
            gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, 255);
            TextureRect_8bIA(&gMasterDisp, D_600E980, 144, 28, D_menu_801AE55C, D_menu_801AE560, 1.0f, 1.0f);
            break;
