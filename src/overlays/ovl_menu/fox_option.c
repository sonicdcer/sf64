...
void Option_Setup(void) {
    ...
    if ((gLastGameState == GSTATE_GAME_OVER) || (gLastGameState == GSTATE_ENDING)) {
        ...
        sOptionCardList[2].frame.x = 0.0f;
        sOptionCardList[2].frame.z = 0.0f;
        sOptionCardList[2].frame.y = 90.0f;
        sOptionCardList[2].frame.xScale = 0.4f;
        sOptionCardList[2].frame.yScale = 0.21f;
        sOptionCardList[2].drawFrame = true;
        sOptionCardList[2].tex.xScale = 1.0f;
        sOptionCardList[2].tex.yScale = 1.0f;
        sOptionCardList[2].tex.xPos = 145.0f;
        sOptionCardList[2].tex.yPos = 25.0f;
        sOptionCardList[2].drawTex = true;
...
void Option_Sound_Draw(void) {
    ...
    if (D_menu_801B9288 == 0) {
        gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, 255);
        Lib_TextureRect_IA8_MirX(&gMasterDisp, D_OPT_800E130, 8, 8, D_menu_801AEFA8[6], D_menu_801AEFD4[6], 1.0f, 1.0f);
        Lib_TextureRect_IA8(&gMasterDisp, D_OPT_800E130, 8, 8, D_menu_801AEFA8[7], D_menu_801AEFD4[7], 1.0f, 1.0f);
    }
...
void Option_Data_Draw(void) {
    ...
    if (D_menu_801B91CC < 2) {
        Lib_TextureRect_IA8_MirX(&gMasterDisp, D_OPT_800E130, 8, 8, D_menu_801AF084[D_menu_801B91C0], 140.0f, 1.0f,
                                 1.0f);
        Lib_TextureRect_IA8(&gMasterDisp, D_OPT_800E130, 8, 8, D_menu_801AF08C[D_menu_801B91C0], 140.0f, 1.0f, 1.0f);
...
void Option_80197A3C(s32 arg0, s32 arg1, s32 arg2) {
    ...
    if (arg0 != 9) {
        Lib_TextureRect_IA8(&gMasterDisp, D_menu_801AECF8[arg0 + 1], 16, 15, arg1, arg2 - 25.0f, 1.0f, 1.0f);
    } else {
        Lib_TextureRect_IA8(&gMasterDisp, aLargeText_1, 16, 15, arg1 - 14.0f, arg2 - 25.0f, 1.0f, 1.0f);
        Lib_TextureRect_IA8(&gMasterDisp, aLargeText_0, 16, 15, arg1, arg2 - 25.0f, 1.0f, 1.0f);
    }
    ...
    switch (arg0) {
        case 0:
            Lib_TextureRect_CI4(&gMasterDisp, D_OPT_8003A70, D_OPT_8003AB8, 16, 9, arg1 + 17.0f, arg2 - 19.0f, 1.0f,
                                1.0f);
            break;

        case 1:
            Lib_TextureRect_CI4(&gMasterDisp, D_OPT_80038E0, D_OPT_8003930, 16, 10, arg1 + 17.0f, arg2 - 19.0f, 1.0f,
                                1.0f);
            break;

        case 2:
            Lib_TextureRect_CI4(&gMasterDisp, D_OPT_8003950, D_OPT_80039A8, 16, 11, arg1 + 17.0f, arg2 - 20.0f, 1.0f,
                                1.0f);
            break;

        default:
            Lib_TextureRect_CI4(&gMasterDisp, D_OPT_8003AE0, D_OPT_8003B28, 16, 9, arg1 + 17.0f, arg2 - 19.0f, 1.0f,
                                1.0f);
            break;
    }
}

void Option_80197D30(s32 rankIdx, s32 xPos, s32 yPos) {
    char rankName[4];
...
void Option_80197DE4(s32 arg0, s32 xPos, s32 yPos) {
    RCP_SetupDL(&gMasterDisp, SETUPDL_83);
    ...
    gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, 255);
    Graphics_DisplaySmallNumber((xPos + 40.0f) - ((HUD_CountDigits(D_menu_801B8220[arg0]) * 8) - 8), (yPos + 9.0f),
                                D_menu_801B8220[arg0]);
}

void Option_80197F74(s32 arg0, s32 xPos, s32 yPos) {
    f32 xOffsetPos;
    s32 i;

    RCP_SetupDL(&gMasterDisp, SETUPDL_83);

    for (xOffsetPos = 0.0f, i = 0; i < 3; i++, xOffsetPos += 12.0f) {
        gDPSetPrimColor(gMasterDisp++, 0, 0, D_menu_801AF0D0[i], D_menu_801AF0DC[i], D_menu_801AF0E8[i], 255);
        Graphics_DisplaySmallText(xOffsetPos + xPos, yPos, 1.0f, 1.0f, D_menu_801AF0C4[i]);
        gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, 255);
        Graphics_DisplaySmallNumber(xPos + xOffsetPos - ((HUD_CountDigits(D_menu_801B81A8[arg0][i]) - 1) * 8),
                                    yPos + 9.0f, D_menu_801B81A8[arg0][i]);
    }
}
...
void Option_801982B0(s32 arg0, s32 arg1, f32 arg2, f32 arg3, s32 arg4) {
    ...
    if ((arg3 > 30.0f) && (arg3 < 200.0f)) {
        ...
        if (arg1 < 6) {
            ...
            if (arg1 < (arg4 - 1)) {
                start = gSaveFile.save.data.stats[arg0][arg1].planetId & 0xF;
                end = gSaveFile.save.data.stats[arg0][arg1 + 1].planetId & 0xF;
            ...
            Lib_TextureRect_RGBA16(&gMasterDisp, D_MAP_60447A0, 8, 8, arg2 + 24.0f, arg3 + 11.0f, 2.0f, 0.2f);
        }
        gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, 255);
        Lib_TextureRect_RGBA16(&gMasterDisp, D_MAP_6047550, 24, 24, arg2, arg3, 1.0f, 1.0f);
    }
}
...
void Option_801984D0(s32 arg0, s32 arg1, f32 arg2, f32 arg3) {
    ...
    if ((arg3 > 22.0f) && (arg3 < 162.0f)) {
        RCP_SetupDL(&gMasterDisp, SETUPDL_83);
        gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 0, 255);
        sp1C = (gSaveFile.save.data.stats[arg0][arg1].unk_C & 1) << 8;
        sp1C |= gSaveFile.save.data.stats[arg0][arg1].hitCount;
...
void Option_80198608(s32 arg0, s32 arg1, f32 xPos, f32 yPos) {
    ...
    if ((yPos > 12.0f) && (yPos < 154.0f)) {
        ...
        sp90[0] = gSaveFile.save.data.stats[arg0][arg1].peppyAlive & 1;
        sp90[1] = gSaveFile.save.data.stats[arg0][arg1].slippyAlive & 1;
        sp90[2] = gSaveFile.save.data.stats[arg0][arg1].falcoAlive & 1;
...
void Option_8019882C(s32 arg0, s32 arg1, f32 arg2, f32 arg3) {
    ...
    if ((arg3 > 58.0f) && (arg3 < 197.0f)) {
        temp = gSaveFile.save.data.stats[arg0][arg1].planetId & 0xF;
...
void Option_8019896C(s32 arg0, f32 y, s32 arg2) {
    ...
    for (x = xStart, i = 0; i < arg2; i++, x += xAdvance) {
        planet = gSaveFile.save.data.stats[arg0][i].planetId & 0xF;
...
void Option_VersusMenu_Setup(void) {
    ...
    if (D_game_800D2870) {
        sOptionCardList[1].tex.yPos = 129.0f;
        sOptionCardList[1].frame.y = -7.5f;
    }
...
void Option_80199820(s32 arg0) {
    ...
    for (i = 0; i < 4; i++) {
        Lib_TextureRect_CI4(&gMasterDisp, D_VS_MENU_70118E0 + (80 * 16 * i) / 2, D_VS_MENU_70123F8, 80, 16,
                            D_menu_801AF148[arg0], D_menu_801AF158[arg0] + (16.0f * i), 1.0f, 1.0f);
    }

    Lib_TextureRect_CI4(&gMasterDisp, D_VS_MENU_70118E0 + (80 * 16 * 4) / 2, D_VS_MENU_70123F8, 80, 7,
    ...
    Lib_TextureRect_CI8(&gMasterDisp, D_menu_801AF1EC[arg0], D_menu_801AF1FC[arg0], D_menu_801AF168[arg0],
    ...
    if ((gGameFrameCount & var_v0) != 0) {
        ...
        Lib_TextureRect_IA8(&gMasterDisp, D_VS_MENU_7001030, 64, 9, D_menu_801AF148[arg0] + D_menu_801AF1BC,
                            D_menu_801AF158[arg0] + D_menu_801AF1C0, 1.0f, 1.0f);

        gDPSetPrimColor(gMasterDisp++, 0, 0, 255, colorGB, colorGB, 255);

        Lib_TextureRect_IA8(&gMasterDisp, D_menu_801AF1E0[D_menu_801AED3C[arg0]], 40, 12,
                            D_menu_801AF148[arg0] + D_menu_801AF1C4, D_menu_801AF158[arg0] + D_menu_801AF1C8, 1.0f,
                            1.0f);
    }

    gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, 255);

    Lib_TextureRect_IA8_MirX(&gMasterDisp, D_OPT_800E130, 8, 8, D_menu_801AF148[arg0] + D_menu_801AF1D4,
                             D_menu_801AF158[arg0] + D_menu_801AF1DC, 1.0f, 1.0f);

    Lib_TextureRect_IA8(&gMasterDisp, D_OPT_800E130, 8, 8, D_menu_801AF148[arg0] + D_menu_801AF1D8,
                        D_menu_801AF158[arg0] + D_menu_801AF1DC, 1.0f, 1.0f);

    Lib_TextureRect_IA8(&gMasterDisp, D_VS_MENU_7000F10, 40, 7, D_menu_801AF148[arg0] + D_menu_801AF1CC,
                        D_menu_801AF158[arg0] + D_menu_801AF1D0, 1.0f, 1.0f);

    gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, 255);

    for (i = 0; i < 2; i++) {
        Lib_TextureRect_RGBA16(&gMasterDisp, D_menu_801AF20C[arg0] + (44 * 20 * i), 44, 20,
                               D_menu_801AF148[arg0] + D_menu_801AF1B4,
                               D_menu_801AF158[arg0] + D_menu_801AF1B8 + (i * 20.0f * 0.7f), 0.7f, 0.7f);
    }

    Lib_TextureRect_RGBA16(&gMasterDisp, D_menu_801AF20C[arg0] + 44 * 20 * 2, 44, 4,
                           D_menu_801AF148[arg0] + D_menu_801AF1B4, D_menu_801AF158[arg0] + D_menu_801AF1B8 + 28.0f,
                           0.7f, 0.7f);
    ...
    Lib_TextureRect_IA8(&gMasterDisp, D_menu_801AF21C[arg0], var_a2, 13, D_menu_801AF148[arg0] + D_menu_801AF19C[arg0],
...
void Option_80199EA8(void) {
    ...
    for (i = 0; i < 3; i++) {
        Lib_TextureRect_RGBA16(&gMasterDisp, D_VS_MENU_700E9A0 + (144 * 14 * i), 144, 14, 87.0f, 84 + (i * 14.0f), 1.0f,
                               1.0f);
    }
}
...
void Option_8019B1F8(void) {
    ...
    for (xPos = D_menu_801AF2A8, i = 0; i < 2; i++, xPos += D_menu_801AF2B0) {
        ...
        Lib_TextureRect_CI8(&gMasterDisp, D_menu_801AF2C4[i], D_menu_801AF2CC[i], 48, 38, xPos, D_menu_801AF2AC, 1.0f,
                            1.0f);
        ...
        RCP_SetupDL(&gMasterDisp, SETUPDL_83);
        gDPSetPrimColor(gMasterDisp++, 0, 0, 255, 255, 255, sp8C[i]);
        Lib_TextureRect_IA8(&gMasterDisp, D_menu_801AF2BC[i], width, 10, D_menu_801AF2B4[i], D_menu_801AF2AC + 40.0f,
                            1.0f, 1.0f);
    }
}
...
void Option_8019B3DC(void) {
    ...
    for (xPos = D_menu_801AF2D4, i = 0; i < 2; i++, xPos += D_menu_801AF2DC) {
        ...
        Lib_TextureRect_CI8(&gMasterDisp, D_menu_801AF2F0[i], D_menu_801AF2F8[i], 48, 38, xPos, D_menu_801AF2D8, 1.0f,
                            1.0f);
        ...
        Lib_TextureRect_IA8(&gMasterDisp, D_menu_801AF2E8[i], 56, 10, D_menu_801AF2E0[i], D_menu_801AF2D8 + 40.0f, 1.0f,
                            1.0f);
    }
}
