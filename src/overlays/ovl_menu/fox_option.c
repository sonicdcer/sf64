...
void Option_VersusUpdate(void) {
    ...
    switch (D_menu_801B912C) {
        ...
        case 1:
            // clang-format off
            if (func_menu_8019C418(&D_menu_801B91A8, 2, 1, 0, 20, 5, 4, gMainController, &D_menu_801B9188)) { AUDIO_PLAY_SFX(0x49000022, gDefaultSfxSource, 4); }
            // clang-format on
...
void Option_InvoiceDraw(void) {
    ...
    TextureRect_4bCI(&gMasterDisp, D_80006A0 + 256 * 16 * 2, D_80017A0, 256, 2, D_menu_801AF3D0[1], D_menu_801AF3F0[1] + 32.0f,
                     1.0f, 1.0f);
