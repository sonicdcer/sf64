...
void func_i6_801888F4(Actor* actor) {
    ...
    if ((actor->timer_0BC == 0) || (actor->unk_0D0 != 0)) {
        func_8007BFFC(actor->obj.pos.x, actor->obj.pos.y, actor->obj.pos.z, actor->vel.x, actor->vel.y, actor->vel.z,
                      7.0f, 20);
            ...
            switch (boss->dmgPart) {
                ...
                case 2:
                    if (boss->swork[4] == 0) {
                        boss->swork[2] = 10;
                        boss->swork[3] = 15;
                        AUDIO_PLAY_SFX(0x2943500FU, boss->sfxPos, 4);
                        boss->health -= boss->damage;
                        if ((boss->health != 0) && (boss->health <= 0)) {
                            D_Timer_80161A60 = 8;
                            AUDIO_PLAY_SFX(0x2940D09AU, boss->sfxPos, 4);
                            func_80042EC0(boss);
                ...
                default:
                    if (boss->swork[4] == 0) {
                        ...
                        if (boss->swork[8] >= 6) {
                            ...
                            AUDIO_PLAY_SFX(0x2940B096U, boss->sfxPos, 4);
                        }
                    }
                    break;
            }
...
void func_i6_80189B70(Boss* boss) {
    ...
    if ((fabsf(boss->obj.pos.x - gPlayer[0].pos.x) < 300.0f) &&
        ...
        boss->state = 11;
        boss->timer_050 = 150;
        AUDIO_PLAY_SFX(0x31408097, boss->sfxPos, 4);
    }
    ...
    switch (boss->state) {
        case 0:
            ...
            boss->swork[5] = 300;
            boss->state++;
            AUDIO_PLAY_SFX(0x11034074, boss->sfxPos, 4);
        ...
        case 11:
            ...
            if (boss->timer_050 == 120) {
                AUDIO_PLAY_SFX(0x1940306E, boss->sfxPos, 4);
            }
            if (boss->timer_050 == 0) {
    ...
    if (boss->swork[5] != 0) {
        boss->swork[5]--;
        if (boss->swork[5] == 0) {
            AUDIO_PLAY_SFX(0x11032075, gActors[10].sfxPos, 4);
            AUDIO_PLAY_SFX(0x11032075, gActors[11].sfxPos, 4);
            AUDIO_PLAY_SFX(0x3103108B, gActors[10].sfxPos, 4);
            AUDIO_PLAY_SFX(0x3103108B, gActors[11].sfxPos, 4);
        }
            ...
            if (boss->state < 12) {
                ...
                if ((boss->state == 9) || (boss->state == 10)) {
                    if (boss->health <= 0) {
                        ...
                        AUDIO_PLAY_SFX(0x2943500F, boss->sfxPos, 4);
                    } else {
                        AUDIO_PLAY_SFX(0x29034003, boss->sfxPos, 4);
                    }
            ...
            case 0:
                if (boss->state < 11) {
                    ...
                    if (boss->swork[6] <= 0) {
                        ...
                        boss->unk_04C = 0;
                        boss->fwork[9] = 0.0f;
                        AUDIO_PLAY_SFX(0x1940306F, boss->sfxPos, 4);
                    }
                }
                break;
            case 1:
                ...
                if (boss->swork[7] == 0) {
                    ...
                    if (boss->dmgPart == 2) {
                        ...
                        if (boss->swork[4] < 0) {
                            ...
                            func_8007BFFC(boss->vwork[0].x, boss->vwork[0].y, boss->vwork[0].z, 0.0f, 0.0f, 0.0f, 20.0f,
                                          15);
                        ...
                        if (boss->swork[5] < 0) {
                            ...
                            func_8007BFFC(boss->vwork[1].x, boss->vwork[1].y, boss->vwork[1].z, 0.0f, 0.0f, 0.0f, 20.0f,
                                          15);
...
void func_i6_8018DA94(Boss* boss, Vec3f* arg1) {
    ...
    AUDIO_PLAY_SFX(0x2903B009, boss->sfxPos, 4);
}
    ...
    switch (boss->state) {
        ...
        case 3:
            if (boss->swork[4] < 0) {
                ...
                if (boss->unk_04C == 60) {
                    AUDIO_PLAY_SFX(0x1940306A, boss->sfxPos, 4);
                }
                if (boss->unk_04C > 60) {
                    if (boss->unk_04C == 76) {
                        boss->fwork[7] = 0.0f;
        ...
        case 5:
            if (boss->swork[5] < 0) {
                ...
                if (boss->timer_050 != 0) {
                    ...
                    Math_SmoothStepToF(&boss->fwork[4], 2.0f, 1.0f, 1.0f, 0);
                    if (boss->unk_04C == 5) {
                        AUDIO_PLAY_SFX(0x1940306B, boss->sfxPos, 4);
                    }
                    boss->swork[7] = 1;
                    boss->fwork[14] = 100.0f;
                }
        ...
        case 6:
            if ((boss->swork[4] < 0) || (boss->swork[5] < 0)) {
                ...
                if (boss->timer_050 == 1) {
                    AUDIO_PLAY_SFX(0x1940306C, boss->sfxPos, 4);
                }
                if (boss->timer_050 != 0) {
                    boss->fwork[6] = -4000.0f;
                    boss->fwork[8] = 0.05f;
        ...
        case 7:
            if (boss->swork[5] < 0) {
                ...
                if (boss->unk_04C == 48) {
                    AUDIO_PLAY_SFX(0x3103108B, boss->sfxPos, 4);
                }
                if (boss->unk_04C > 48) {
        ...
        case 15:
            ...
            Math_SmoothStepToF(&boss->fwork[9], 1.0f, 1.0f, 0.01f, 0);
            if (boss->unk_04C == 15) {
                AUDIO_PLAY_SFX(0x29022088, boss->sfxPos, 4);
            }
            if ((boss->unk_04C > 35) && (boss->unk_04C < 150) && !(boss->unk_04C & 0x1F)) {
                AUDIO_PLAY_SFX(0x29022089, boss->sfxPos, 4);
        ...
        case 16:
            ...
            Math_SmoothStepToVec3fArray(spD0, D_i6_801A7F80, 1, limbCount, boss->fwork[9], 100.0f, 0.0f);
            if (boss->unk_04C == 10) {
                AUDIO_PLAY_SFX(0x3140208A, boss->sfxPos, 4);
            }
        ...
        case 17:
            ...
            if (boss->timer_050 > 0) {
                ...
                for (i = 0; i < 16; i++, playerShot++) {
                    ...
                    if ((playerShot->obj.id == PLAYERSHOT_3) && (playerShot->obj.status == 1) &&
                        ...
                        boss->unk_04C = 0;
                        boss->swork[8] = 2;
                        AUDIO_PLAY_SFX(0x1940306D, boss->sfxPos, 4);
                        break;
                    }
                }
            ...
            Math_SmoothStepToF(&boss->fwork[9], 1.0f, 1.0f, 0.01f, 0);
            if (boss->unk_04C == 10) {
                AUDIO_PLAY_SFX(0x31022087, boss->sfxPos, 4);
            }
            boss->unk_04C++;
            ...
            switch (boss->unk_044) {
                ...
                case 1:
                    if (boss->timer_050 != 0) {
                        ...
                        boss->timer_050 = 70;
                        boss->fwork[9] = 0.0f;
                        AUDIO_PLAY_SFX(0x1940307C, boss->sfxPos, 4);
                    }
...
void func_i6_80192E94(Actor* actor) {
    ...
    switch (actor->state) {
        case 0:
            ...
            AUDIO_PLAY_SFX(0x11000028, actor->sfxPos, 0);
            break;
        case 1:
            otherActor = gActors;
...
void func_i6_80193C4C(Player* player) {
    ...
    switch (player->unk_1D0) {
        ...
        case 2:
            ...
            sp68.z = 0.0f;
            if (gCsFrameCount == 50) {
                AUDIO_PLAY_SFX(0x11403071, player->sfxPos, 0);
                func_8001D400(0);
            }
            if (gCsFrameCount > 40) {
                sp90 = 1;
            ...
            switch (gCsFrameCount) {
                ...
                case 25:
                    for (i = 0; i < 12; i++) {
                        func_i6_80193668(&gObjects80[i], player->pos.x, player->pos.y,
                                         (player->camEye.z - D_80177D20) + (2195.0f * i), i);
                    }
                    break;
                case 150:
        ...
        case 3:
            ...
            if ((gCsFrameCount == 20) && (D_800D2F68 != 0)) {
                func_i6_801939A0(1);
            }
            if (gCsFrameCount == 40) {
                func_i6_801939A0(10);
                AUDIO_PLAY_SFX(0x2940F026, boss->sfxPos, 4);
                D_80178480 = 30;
                gOverlayStage = 1;
                D_Timer_80177BD0[0] = 30;
            }
            if (gCsFrameCount > 40) {
                ...
                Math_SmoothStepToF(&gCsCamAtY, gActors[10].obj.pos.y, 1.0f, D_80177A48[1], 0.0f);
        ...
        case 5:
            ...
            if (D_800D2F68 != 0) {
                if (gCsFrameCount >= 1000) {
                    gCsCamAtX += D_80177A48[4] * 0.15f;
                    gCsCamEyeZ += D_80177A48[4];
                ...
                Math_SmoothStepToF(&player->camEye.z, gCsCamEyeZ, D_80177A48[0], D_80177A48[1], 0);
