...
void func_i6_80198244(Boss* boss) {
    ...
    boss->fwork[34] = 2.8f;
    AUDIO_PLAY_SFX(0x2902306C, boss->sfxPos, 4);
}
    ...
    if (boss->health <= 0) {
        if (boss->index == 0) {
            ...
            if (boss->timer_058 == 50) {
                AUDIO_PLAY_SFX(0x2903A060, boss->sfxPos, 4);
            ...
            Math_SmoothStepToF(&gPlayer[0].camEye.x, gCsCamEyeX, D_80177A48[0], 20000.0f, 0);
            Math_SmoothStepToF(&gPlayer[0].camEye.y, gCsCamEyeY, D_80177A48[0], 20000.0f, 0);
            Math_SmoothStepToF(&gPlayer[0].camEye.z, gCsCamEyeZ, D_80177A48[0], 20000.0f, 0);
            Math_SmoothStepToF(&gPlayer[0].camAt.x, gCsCamAtX, D_80177A48[0], 20000.0f, 0);
            Math_SmoothStepToF(&gPlayer[0].camAt.y, gCsCamAtY, D_80177A48[0], 20000.0f, 0);
            Math_SmoothStepToF(&gPlayer[0].camAt.z, gCsCamAtZ, D_80177A48[0], 20000.0f, 0);
        }
        ...
        if (boss->health < 80) {
            if (boss->swork[25] == 0) {
                ...
                boss->info.hitbox = SEGMENTED_TO_VIRTUAL(D_6034304);
                AUDIO_PLAY_SFX(0x2903A06F, boss->sfxPos, 4);
            }
        }
        if (boss->health <= 80) {
            boss->swork[33] = 3500;
...
void func_i6_8019A434(Boss* boss) {
    ...
    boss->fwork[12] = 30.0f;
    boss->fwork[10] = 181.0f;
    AUDIO_PLAY_SFX(0x19031003, boss->sfxPos, 4);
}
...
void func_i6_8019A520(Boss* boss) {
    ...
    if ((boss->unk_04C == 0) || (boss->unk_04C == 27)) {
        AUDIO_PLAY_SFX(0x29022019, boss->sfxPos, 4);
    }
}
...
void func_i6_8019AAF0(Boss* boss) {
    ...
    if (boss->unk_04C >= boss->swork[32] - 29) {
        if (boss->unk_04C == boss->swork[32] - 29) {
            if (boss->swork[31] == 11) {
                AUDIO_PLAY_SFX(0x2903401C, boss->sfxPos, 4);
            } else {
                AUDIO_PLAY_SFX(0x2902306D, boss->sfxPos, 4);
            }
        }
...
void func_i6_8019AEEC(Boss* boss) {
    ...
    if ((boss->obj.pos.y != 365.0f) && (boss->swork[21] != 1)) {
        ...
        if (boss->timer_056 == 95) {
            AUDIO_PLAY_SFX(0x3102505A, gActors[59].sfxPos, 4);
        }
        ...
        if (boss->timer_056 == 55) {
            ...
            Audio_KillSfxBySource(gActors[59].sfxPos);
            boss->fwork[34] = 4.5f;
...
void func_i6_8019BC14(Boss* boss) {
    ...
    if ((fabsf(boss->fwork[3] - boss->fwork[0x14]) > 300.0f) || (fabsf(boss->fwork[1] - boss->fwork[0x12]) > 300.0f)) {
        ...
        if (((sp38 < 41.0f) || (sp38 > 319.0f)) && ((var_fa0 < 41.0f) || (var_fa0 > 319.0f))) {
            ...
            if (boss->index == 0) {
                AUDIO_PLAY_SFX(0x2901306EU, boss->sfxPos, 4U);
            } else {
                AUDIO_PLAY_SFX(0x2900306BU, boss->sfxPos, 4U);
            }
        }
    }
    if (boss->index == 0) {
        ...
        if (boss->index == 0) {
            ...
            if (sp2C > 0.0f) {
                if (boss->fwork[41] == 0.0f) {
                    boss->fwork[41] = ABS(sp2C * 0.01f) + 0.8f;
                    AUDIO_PLAY_SFX(0x09000003, boss->sfxPos, 4);
                }
    ...
    switch (player->unk_1D0) {
        ...
        case 3:
            ...
            if (gCsFrameCount == 343) {
                AUDIO_PLAY_SFX(0x09000007, player->sfxPos, 0);
            }
            if (gCsFrameCount == 395) {
                AUDIO_PLAY_SFX(0x09000013, player->sfxPos, 0);
            }
            ...
            gCsCamEyeX = sp54.x;
            gCsCamEyeY = D_80177A48[9];
            gCsCamEyeZ = 295.0f + sp54.z;
            gCsCamAtX = 0.0f;
            gCsCamAtY = 3500.0f;
            gCsCamAtZ = D_80177A48[7] + player->pos.z;
...
void func_i6_801A07FC(Actor* actor0, Actor* actor1) {
    ...
    actor1->unk_0B6 = 42;
    AUDIO_PLAY_SFX(0x2900306B, actor1->sfxPos, 4);
}
...
void func_i6_801A0A08(Actor* actor, f32 xPos, f32 yPos, f32 zPos, f32 arg4) {
    ...
    actor->iwork[0] = 255;
    actor->unk_0B6 = 43;
    AUDIO_PLAY_SFX(0x2900306B, actor->sfxPos, 4);
}
    ...
    switch (player->unk_1D0) {
        ...
        case 1:
            ...
            switch (gCsFrameCount) {
                ...
                case 145:
                    ...
                    AUDIO_PLAY_SFX(0x2903A060, gActors[11].sfxPos, 4);
                    break;
                case 188:
                    gActors[5].fwork[0] = gActors[6].fwork[0] = gActors[7].fwork[0] = 3.8f;
                    AUDIO_PLAY_SFX(0x2902306C, gActors[5].sfxPos, 4);
                    AUDIO_PLAY_SFX(0x2902306C, gActors[6].sfxPos, 4);
                    AUDIO_PLAY_SFX(0x2902306C, gActors[7].sfxPos, 4);
                    break;
                case 150:
                ...
                case 240:
                    ...
                    AUDIO_PLAY_SFX(0x2940F026, gActors[5].sfxPos, 4);
        ...
        case 2:
            ...
            if (gCsFrameCount >= 300) {
                ...
                player->camEye.y = gCsCamEyeY = D_80177A48[3] + sp98.y;
            ...
            if (gCsFrameCount == 280) {
                ...
                AUDIO_PLAY_SFX(0x31000011, gActors[5].sfxPos, 4);
            }
    ...
    switch (actor->unk_046) {
        ...
        case 3:
            ...
            if (actor->timer_0BE == 5U) {
                ...
                AUDIO_PLAY_SFX(0x2903A060, actor->sfxPos, 4);
            }
            if (actor->timer_0BE == 0) {
...
void func_i6_801A4E44(Object_80* obj80) {
    ...
    if (obj80->state == 0) {
        AUDIO_PLAY_SFX(0x1900404F, obj80->sfxPos, 4);
        obj80->state++;
    }
    if (!(gGameFrameCount & 3)) {
