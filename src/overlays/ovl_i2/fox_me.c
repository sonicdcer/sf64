...
void func_i2_80187E38(f32 x, f32 y, f32 z, f32 arg3) {
    ...
    for (i = ARRAY_COUNT(gEffects) - 1; i >= 0; i--) {
        if (gEffects[i].obj.status == OBJ_FREE) {
            ...
            AUDIO_PLAY_SFX(0x31037057U, gEffects[i].sfxPos, 4U);
            break;
        }
    }
...
void func_i2_80188088(Boss* boss) {
    ...
    for (i = ARRAY_COUNT(gEffects) - 1; i >= 0; i--) {
        if (gEffects[i].obj.status == OBJ_FREE) {
            ...
            AUDIO_PLAY_SFX(0x19006035U, gEffects[i].sfxPos, 4U);
            break;
        }
    }
...
void func_i2_80188298(f32 x, f32 y, f32 z, f32 zRot) {
    ...
    for (i = ARRAY_COUNT(gEffects) - 1; i >= 0; i--) {
        if (gEffects[i].obj.status == OBJ_FREE) {
            ...
            AUDIO_PLAY_SFX(0x3102705CU, gEffects[i].sfxPos, 4U);
            break;
        }
    }
}
...
void func_i2_80188A40(Boss* boss) {
    ...
    AUDIO_PLAY_SFX(0x3102505AU, boss->sfxPos, 4U);
}
...
void func_i2_8018978C(Boss* boss) {
            ...
            if (boss->state >= 9) {
                if (boss->dmgPart == 5) {
                    if ((boss->swork[7] != 0) && (boss->fwork[22] > 0.8f)) {
                        AUDIO_PLAY_SFX(0x2943500FU, boss->sfxPos, 4U);
                        boss->swork[14] = 20;
    ...
    if (boss->swork[18] != 0) {
        ...
        AUDIO_PLAY_SFX(0x2903201BU, boss->sfxPos, 4U);
    ...
    switch (boss->state) {
        ...
        case 3:
            ...
            if (gBosses[boss->unk_044].state < 3) {
                ...
                if ((boss->timer_050 == 0) && (gBosses[boss->unk_044].state == 2)) {
                    ...
                    AUDIO_PLAY_SFX(0x19030036U, boss->sfxPos, 4U);
                }
        ...
        case 5:
            ...
            if (boss->timer_050 == 1) {
                AUDIO_PLAY_SFX(0x31016056U, boss->sfxPos, 4U);
            }
        ...
        case 6:
            ...
            if (gPlayer[0].state_1C8 != PLAYERSTATE_1C8_6) {
                ...
                if (boss->timer_050 == 0) {
                    boss->state = 7;
                    AUDIO_PLAY_SFX(0x29038058U, boss->sfxPos, 4U);
                }
                func_i2_80189624();
            }
            break;
        ...
        case 8:
            ...
            if (boss->timer_050 == 0) {
                ...
                if (boss->obj.rot.x < -178.0f) {
                    ...
                    boss->timer_050 = 0;
                    boss->fwork[15] = 8.0f;
                    AUDIO_PLAY_SFX(0x11015034U, boss->sfxPos, 4U);
                }
            }
            break;
        ...
        case 20:
            ...
            if (boss->timer_050 == 20) {
                ...
                AUDIO_PLAY_SFX(0x2940F026U, boss->sfxPos, 4U);
...
void func_i2_8018DF08(Actor* actor, s32 idx) {
    ...
    if (idx == 3) {
        AUDIO_PLAY_SFX(0x11030010U, actor->sfxPos, 0);
        AUDIO_PLAY_SFX(0x31024059U, actor->sfxPos, 0);
        actor->unk_0B6 = 1;
    } else {
        actor->iwork[11] = 1;
        AUDIO_PLAY_SFX(0x3100000CU, actor->sfxPos, 4U);
...
void func_i2_8018E084(Player* player) {
    ...
    switch (gCsFrameCount) {
        ...
        case 1390:
            AUDIO_PLAY_SFX(0x09000002U, player->sfxPos, 0);
            player->unk_194 = 5.0f;
            player->unk_190 = 5.0f;
            break;
...
void func_i2_8018ED9C(Actor* actor) {
    ...
    switch (actor->state) {
        ...
        case 1:
            actor->state = 2;
            AUDIO_PLAY_SFX(0x09000002U, actor->sfxPos, 0U);
