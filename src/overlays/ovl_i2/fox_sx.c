    ...
    switch (boss->state) {
        ...
        case 90:
            if ((boss->timer_050 == 110) || (boss->timer_050 == 66)) {
                AUDIO_PLAY_SFX(0x29433022, boss->sfxPos, 4);
            }
            ...
            if (boss->timer_050 == 0) {
                boss->state = 100;
                boss->fwork[0] = 0.0f;
                AUDIO_PLAY_SFX(0x29400023, boss->sfxPos, 4);
            }
        ...
        case 100:
            ...
            if (boss->unk_04C >= Animation_GetFrameCount(&D_60206DC)) {
                ...
                boss->state = 1;
                boss->fwork[0] = 0.0f;
                AUDIO_PLAY_SFX(0x29402024, boss->sfxPos, 4);
            }
        ...
        case 2: // right arm attack
            ...
            if (boss->unk_04C == 60) {
                AUDIO_PLAY_SFX(0x2902401C, boss->sfxPos, 4);
                boss->fwork[42] = 0.0f;
            }
...
void func_i2_80194728(Player* player) {
    ...
    switch (gCsFrameCount) {
        ...
        case 920:
            ...
            AUDIO_PLAY_SFX(0x11030010, gActors[0].sfxPos, 0);
            break;
