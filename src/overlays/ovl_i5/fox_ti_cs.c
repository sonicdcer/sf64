...
void Titania_LevelStart(Player* player) {
    ...
    switch (player->csState) {
        case 0:
            ...
            player->cam.eye.x = gNextCamEyeX = 5000.0f;
            player->cam.eye.y = gNextCamEyeY = 1000.0f;
            player->cam.eye.z = gNextCamEyeZ = -5000.0f;
        ...
        case 1:
            ...
            sp64 = 20.0f;
            gNextCamEyeX = actor->obj.pos.x - 500.0f;
            gNextCamEyeY = actor->obj.pos.y - 500.0f;
            gNextCamEyeZ = actor->obj.pos.z - 750.0f;
        ...
        case 2:
            ...
            if (gCsFrameCount == 500) {
                ...
                player->cam.eye.z = gNextCamEyeZ = player->pos.z + player->zPath + sp48.z;
            }
            break;
        ...
        case 3:
            ...
            gNextCamEyeX = sp48.x;
            gNextCamEyeY = sp48.y;
            gNextCamEyeZ = player->pos.z + player->zPath + sp48.z;
            gNextCamAtX = player->pos.x;

            player->cam.at.x = gNextCamAtX;
            player->cam.at.y = gNextCamAtY = player->pos.y;
            player->cam.at.z = gNextCamAtZ = player->pos.z + player->zPath;
    ...
    Math_SmoothStepToF(&player->cam.eye.x, gNextCamEyeX, D_ctx_80177A48[0], sp64, 0.00f);
    Math_SmoothStepToF(&player->cam.eye.y, gNextCamEyeY, D_ctx_80177A48[0], sp64, 0.00f);
    Math_SmoothStepToF(&player->cam.eye.z, gNextCamEyeZ, D_ctx_80177A48[0], sp64, 0.00f);
    Math_SmoothStepToF(&player->cam.at.x, gNextCamAtX, D_ctx_80177A48[0], sp64, 0.00f);
    Math_SmoothStepToF(&player->cam.at.y, gNextCamAtY, D_ctx_80177A48[0], sp64, 0.00f);
    Math_SmoothStepToF(&player->cam.at.z, gNextCamAtZ, D_ctx_80177A48[0], sp64, 0.00f);
}
...
void Titania_LevelComplete(Player* player) {
    ...
    switch (player->csState) {
        ...
        case 1:
            ...
            gNextCamEyeZ = player->pos.z + player->zPath + dest.z + 50.0f;
    ...
    Math_SmoothStepToF(&player->cam.eye.x, gNextCamEyeX, D_ctx_80177A48[0], 20000.0f, 0.00f);
    Math_SmoothStepToF(&player->cam.eye.y, gNextCamEyeY, D_ctx_80177A48[0], 20000.0f, 0.00f);
    Math_SmoothStepToF(&player->cam.eye.z, gNextCamEyeZ, D_ctx_80177A48[0], 20000.0f, 0.00f);
    Math_SmoothStepToF(&player->cam.at.x, gNextCamAtX, D_ctx_80177A48[0], 20000.0f, 0.00f);
    Math_SmoothStepToF(&player->cam.at.y, gNextCamAtY, D_ctx_80177A48[0], 20000.0f, 0.00f);
    Math_SmoothStepToF(&player->cam.at.z, gNextCamAtZ, D_ctx_80177A48[0], 20000.0f, 0.00f);
