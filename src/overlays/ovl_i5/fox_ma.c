...
void Macbeth_MaLocomotive_Update(MaLocomotive* this) {
    ...
    if ((gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_COMPLETE) && (gCsFrameCount > 630)) {
        Object_Kill(&this->obj, this->sfxSource);
    }
}
...
void Macbeth_Actor207_Update(Actor207* this) {
    ...
    switch (this->state) {
        ...
        case 4:
            ...
            if ((D_i5_801BE320[16] != 0) && (gPlayer[0].state_1C8 == PLAYERSTATE_ACTIVE)) {
                var_v1 = 0xFF;
    ...
    if ((D_i5_801BE320[16] != 0) && (gPlayer[0].state_1C8 != PLAYERSTATE_LEVEL_COMPLETE)) {
    ...
    if ((gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_COMPLETE) && (this->state < 20)) {
        D_i5_801BE320[3] = 0;
        D_i5_801BE320[2] = 1;
        D_i5_801BE320[31] = 30;
        this->state = 20;
