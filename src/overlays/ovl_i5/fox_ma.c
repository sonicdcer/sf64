    ...
    for (var_v0 = D_i5_801BE2F0[0]; D_i5_801BA1EC[var_v0].unk_00 != -1.0f; var_v0++) {
        if (D_i5_801BA1EC[var_v0].unk_00 < gPlayer[0].unk_138) {
            ...
            if (D_i5_801BA1E4 != D_i5_801BA1EC[var_a0 - 1].unk_04) {
                AUDIO_PLAY_SFX(0x1940205E, actor->sfxPos, 0);
            }
...
void func_i5_8019A8C8(Actor* actor, s16 arg1) {
    ...
    AUDIO_PLAY_SFX(0x2940C00A, actor->sfxPos, 4);
}
...
bool func_i5_8019C4EC(Actor* actor) {
    if (actor->unk_0D0 != 0) {
        actor->unk_0D0 = 0;
        if (actor->unk_0D2 == 1) {
            AUDIO_PLAY_SFX(0x29034003, actor->sfxPos, 4);
            actor->unk_0D0 = 0;
            actor->iwork[7] = 15;
            D_i5_801BE320[22] = 0;
            D_i5_801BE320[4] = 120;
        ...
        AUDIO_PLAY_SFX(0x29121007, actor->sfxPos, 4);
    }
    ...
    switch (actor->state) {
        ...
        case 1:
            if (actor->timer_0BC == 1) {
                AUDIO_PLAY_SFX(0x1900000D, actor->sfxPos, 4);
            }
            if (actor->timer_0BC <= 0) {
                ...
                if ((actor->fwork[2] < -58.0f) && ((func_i5_8019C4EC(actor) != 0) || (actor->timer_0BE <= 0))) {
                    ...
                    D_i5_801BE320[19] = 0;
                    actor->state++;
                    AUDIO_PLAY_SFX(0x1900000E, actor->sfxPos, 4);
                }
            }
            break;
        case 2:
        ...
        case 5:
            ...
            if (actor->timer_0BC == 100) {
                ...
                actor->state++;
                Audio_KillSfxBySourceAndId(gPlayer[0].sfxPos, 0x1100000A);
                Audio_KillSfxBySourceAndId(gPlayer[0].sfxPos, 0x01004024);
            }
            break;
    }
    ...
    switch (actor->iwork[4]) {
        case 0:
            if (sp44 != 0) {
                ...
                AUDIO_PLAY_SFX(0x2903101B, actor->sfxPos, 4);
                actor->iwork[4]++;
...
void func_i5_801A0BD8(Object_80* obj80) {
    switch (obj80->state) {
        ...
        case 1:
            if (obj80->timer_4C == 1) {
                AUDIO_PLAY_SFX(0x01004024, gPlayer[0].sfxPos, 0);
            }
            if (obj80->timer_4C <= 0) {
                Math_SmoothStepToF(&obj80->vel.x, 1751.0f, 0.2f, 80.0f, 1.0f);
                if (obj80->vel.x >= 1750.0) {
                    AUDIO_PLAY_SFX(0x1940807B, obj80->sfxPos, 0);
                    Audio_KillSfxBySourceAndId(gPlayer[0].sfxPos, 0x01004024);
                    obj80->timer_4C = 5;
                    obj80->state = 2;
                }
...
void func_i5_801A3E98(Actor* actor) {
    ...
    switch (actor->state) {
        case 0:
            if ((actor->unk_0D0 != 0) && (actor->unk_0D0 != 3)) {
                actor->unk_0D0 = 0;
                AUDIO_PLAY_SFX(0x1903205F, actor->sfxPos, 0);
                actor->state = 1;
            }
            break;
        case 1:
            ...
            if (actor->fwork[1] <= -180.0f) {
                AUDIO_PLAY_SFX(0x19033008, actor->sfxPos, 0);
    ...
    if (actor->fwork[0] < 31.0f) {
        if (actor->state >= 3) {
            AUDIO_PLAY_SFX(0x19020060, actor->sfxPos, 0);
        } else {
            AUDIO_PLAY_SFX(0x19020061, actor->sfxPos, 0);
        }
        ...
        case 0:
            if (actor->timer_0BC == 0) {
                ...
                if (actor->obj.pos.y < 80.0f) {
                    if (actor->unk_046 != 0) {
                        AUDIO_PLAY_SFX(0x19030006, actor->sfxPos, 0);
...
void func_i5_801A49B8(Actor* actor) {
    if (actor->unk_0D0 != 0) {
        AUDIO_PLAY_SFX(0x29024003, actor->sfxPos, 0);
        actor->timer_0C6 = 15;
...
void func_i5_801A4B24(Actor* actor) {
    ...
    switch (actor->state) {
        ...
        case 6:
            if (actor->timer_0BC == 1) {
                AUDIO_PLAY_SFX(0x1940405D, actor->sfxPos, 0);
            }
            if (actor->timer_0BC == 0) {
...
void func_i5_801A57D0(Effect* effect) {
    ...
    if ((fabsf(gPlayer[0].unk_138 - effect->obj.pos.z) < 50.0f) &&
        ...
        if ((gPlayer[0].unk_280 != 0) || (gPlayer[0].timer_27C != 0)) {
            ...
            effect->vel.y = sp44.y;
            effect->vel.z = sp44.z;
            AUDIO_PLAY_SFX(0x09007011, effect->sfxPos, 4);
        }
...
void func_i5_801A5E54(Actor* actor) {
    ...
    if ((D_i5_801BA1E0 - actor->obj.pos.z) < -800.0f) {
        if (actor->iwork[0] == 0) {
            AUDIO_PLAY_SFX(0x11001063, actor->sfxPos, 0);
            actor->iwork[0]++;
        }
...
void func_i5_801A5FD0(Actor* actor) {
    ...
    if (gPlayer[0].unk_138 - actor->obj.pos.z < actor->fwork[2]) {
        if (actor->iwork[0] == 0) {
            AUDIO_PLAY_SFX(0x19001062, actor->sfxPos, 0);
            actor->iwork[0] += 1;
        }
    ...
    switch (actor->state) {
        case 0:
            if (actor->unk_0D0 != 0) {
                ...
                AUDIO_PLAY_SFX(0x2903300E, actor->sfxPos, 4);
                actor->health -= actor->damage;
                actor->timer_0C6 = 15;
                ...
                if (actor->health <= 0) {
                    AUDIO_PLAY_SFX(0x2903B009, actor->sfxPos, 0);
    ...
    switch (actor->state) {
                    ...
                    if ((D_i5_801BE320[9] > 0) || (D_i5_801BE320[10] > 0)) {
                        ...
                        if (((D_i5_801BE320[9] > 0) && (Rand_ZeroOne() > 0.5f)) || (D_i5_801BE320[10] <= 0) ||
                            ...
                            if (D_i5_801BE320[9] > 0) {
                                ...
                                D_i5_801BE320[31] = 30;
                                actor->timer_0BC = 100;
                                AUDIO_PLAY_SFX(0x19022067, actor->sfxPos, 4);
                                actor->state = 12;
                            }
            ...
            if ((gPlayer[0].unk_138 - actor->obj.pos.z) < 1200.0f) {
                if (D_i5_801BE320[3] < (Animation_GetFrameCount(&D_601D188) - 1)) {
                    ...
                    if ((D_i5_801BE320[3] == 26) && (D_i5_801BE320[10] > 0)) {
                        ...
                        AUDIO_PLAY_SFX(0x2902405E, actor->sfxPos, 4);
                    }
                } else {
                    actor->info.hitbox = SEGMENTED_TO_VIRTUAL(D_800CBF34);
        ...
        case 8:
            ...
            if (!(gGameFrameCount & 0xF)) {
                AUDIO_PLAY_SFX(0x29036099, actor->sfxPos, 4);
            }
            ...
            if (actor->unk_0D0 != 0) {
                ...
                if (D_i5_801BE320[29] <= 0) {
                    ...
                    D_80178348 = D_80178350 = D_80178354 = D_80178340 = 255;
                    AUDIO_PLAY_SFX(0x2940D09A, actor->sfxPos, 4);
                ...
                if (D_i5_801BE320[29] > 0) {
                    if (D_i5_801BE320[29] > 100) {
                        ...
                        AUDIO_PLAY_SFX(0x2943500F, actor->sfxPos, 4);
                    }
                }
            }
            if (!(gGameFrameCount & 1)) {
        ...
        case 12:
            ...
            func_i5_801A6984(actor);
            if (D_i5_801BE320[9] <= 0) {
                Audio_KillSfxBySourceAndId(actor->sfxPos, 0x19022067);
                actor->state = 14;
                actor->vel.y = -20.0f;
            }
        ...
        case 13:
            ...
            if (actor->timer_0BC == 60) {
                AUDIO_PLAY_SFX(0x19023068, actor->sfxPos, 4);
                D_i5_801BE320[24] = 0;
        ...
        case 15:
            ...
            if (actor->timer_0BC < 100) {
                if (actor->timer_0BC == 98) {
                    AUDIO_PLAY_SFX(0x19022069, actor->sfxPos, 4);
                }
            ...
            if (actor->timer_0BC == 0) {
                ...
                actor->state = 16;
                Audio_KillSfxBySourceAndId(actor->sfxPos, 0x19022069);
            }
            break;
        case 16:
            Math_SmoothStepToAngle(&actor->obj.rot.y, 0.0f, 0.1f, 20.0f, 0.01f);
            ...
            if (actor->timer_0BC < (D_i5_801BE320[27] - 40)) {
                if ((actor->timer_0BC + 42) == D_i5_801BE320[27]) {
                    ...
                    AUDIO_PLAY_SFX(0x19006035, actor->sfxPos, 4);
            ...
            if (actor->timer_0BC == 0) {
                Audio_KillSfxBySourceAndId(actor->sfxPos, 0x19006035);
                actor->info.hitbox = SEGMENTED_TO_VIRTUAL(D_603677C);
                D_i5_801BE320[3] = 0;
                D_i5_801BE320[2] = 1;
                D_i5_801BE320[31] = 30;
    ...
    switch (actor->state) {
        case 0:
            ...
            if (actor->iwork[1] != 0) {
                ...
                AUDIO_PLAY_SFX(0x19034066, actor->sfxPos, 4);
...
void func_i5_801AC6B4(Actor* actor) {
    ...
    Object_SetInfo(&actor->info, actor->obj.id);
    AUDIO_PLAY_SFX(0x11030010, actor->sfxPos, 0);
    actor->unk_0B6 = 1;
}
...
void func_i5_801AC754(Player* player) {
    ...
    Math_SmoothStepToF(&player->camEye.x, gCsCamEyeX, D_80177A48[0], sp4C, 0);
    Math_SmoothStepToF(&player->camEye.y, gCsCamEyeY, D_80177A48[1], sp48, 0);
    Math_SmoothStepToF(&player->camEye.z, gCsCamEyeZ, D_80177A48[2], sp44, 0);
    Math_SmoothStepToF(&player->camAt.x, gCsCamAtX, D_80177A48[0], sp4C, 0);
    Math_SmoothStepToF(&player->camAt.y, gCsCamAtY, D_80177A48[1], sp48, 0);
    Math_SmoothStepToF(&player->camAt.z, gCsCamAtZ, D_80177A48[2], sp44, 0);
    player->unk_0A0 = 0.0f;
...
void func_i5_801ADC08(Actor* actor, f32 xPos, f32 yPos, f32 zPos, f32 xVel, f32 yVel, f32 zVel) {
    ...
    actor->timer_0BC = 0;
    Object_SetInfo(&actor->info, actor->obj.id);
    AUDIO_PLAY_SFX(0x2900201D, actor->sfxPos, 4);
}
    ...
    switch (actor->state) {
        case 0:
            ...
            if ((func_8006351C(actor->index, &actor->obj.pos, &sp3C, 1) != 0) ||
                ...
                AUDIO_PLAY_SFX(0x19032064, actor->sfxPos, 4);
                D_80137E84[gMainController] = 1;
    ...
    switch (actor->state) {
        case 0:
            ...
            if (actor->obj.pos.y < (gGroundLevel + 35.0f)) {
                ...
                actor->state = 1;
                actor->timer_0BC = 200;
                AUDIO_PLAY_SFX(0x11000028, actor->sfxPos, 4);
            }
            break;
        case 1:
...
void func_i5_801AF27C(Actor* actor, s32 arg1) {
    ...
    if (arg1 < 3) {
        ...
        actor->state = 30;
        AUDIO_PLAY_SFX(0x3100000C, actor->sfxPos, 4);
    } else {
        actor->unk_0B6 = 1;
        actor->state = 21;
...
void func_i5_801AF8F4(Player* player) {
    ...
    switch (player->unk_1D0) {
        case 0:
            ...
            player->camEye.z = gCsCamEyeZ = gActors[D_i5_801BE318].obj.pos.z + D_80177D20 + 500.0f;
            player->camAt.x = gCsCamAtX = gActors[D_i5_801BE318].obj.pos.x;
            player->camAt.y = gCsCamAtY = gActors[D_i5_801BE318].obj.pos.y + 200.0f;
            player->camAt.z = gCsCamAtZ = gActors[D_i5_801BE318].obj.pos.z + D_80177D20;
            player->pos.x = 500.0f;
            player->pos.y = -3.0f;
            D_i5_801BA1DC = 0.0f;
            player->unk_4D8 = 0.0f;
        ...
        case 3:
            ...
            if (gCsFrameCount >= 252) {
                ...
                gCsCamAtZ = (gActors[D_i5_801BE314].obj.pos.z + D_80177D20) - 2000.0f;
            ...
            if (gCsFrameCount == 389) {
                ...
                AUDIO_PLAY_SFX(0x31408095, gActors[D_i5_801BE314].sfxPos, 4);
                D_i5_801BE313 = 0;
            }
            break;
        case 4:
            ...
            if (gCsFrameCount == 416) {
                ...
                player->camAt.z = gCsCamAtZ = (gActors[D_i5_801BE314].obj.pos.z + D_80177D20) - 2000.0f;
                player->camEye.y = gCsCamEyeY = 50.0f;
                player->camAt.y = gCsCamAtY = 10.0f;
                player->camEye.x = gCsCamEyeX = D_80177A48[7] + gCsCamAtX;
                player->camEye.z = gCsCamEyeZ = D_80177A48[8] + gCsCamAtZ;
        ...
        case 5:
            ...
            if (gCsFrameCount <= 505) {
                ...
                player->pos.z = player->unk_138 = -(D_80177D20 + 210.0f);
                player->unk_140 = -gActors[D_i5_801BE314].vel.z;
                gCsCamEyeX = D_80177A48[7] + gCsCamAtX;
                gCsCamEyeZ = D_80177A48[8] + gCsCamAtZ;
                ...
                Math_SmoothStepToF(&gCsCamAtY, 1600.0f, 0.1f, D_80177A48[5], 0.0f);
            ...
            if (gCsFrameCount == 630) {
                Audio_KillSfxBySourceAndId(gActors[D_i5_801BE314].sfxPos, 0x31408095);
                AUDIO_PLAY_SFX(0x2940C00A, gActors[D_i5_801BE314].sfxPos, 4);
                player->unk_1D0++;
                player->vel.z = 0.0f;
                player->unk_140 = 0.0f;
                D_80177D08 = 0.0f;
        ...
        case 6:
            ...
            if (gCsFrameCount == 880) {
                ...
                D_80178358 = 255;
                D_8017835C = 20;
                AUDIO_PLAY_SFX(0x2940F026, gActors[D_i5_801BE314].sfxPos, 4);
            ...
            if (gCsFrameCount == 940) {
                ...
                player->camEye.z = gCsCamEyeZ = (player->unk_138 + D_80177D20) - 300.0f;
                player->camAt.z = gCsCamAtZ = player->unk_138 + D_80177D20;
        ...
        case 7:
            ...
            if ((gCsFrameCount >= 1059) && (gCsFrameCount < 2120)) {
                ...
                gCsCamEyeZ = player->pos.z + D_80177D20 + spD8.z;
            }
            if (gCsFrameCount >= 2120) {
                ...
                Math_SmoothStepToF(&gCsCamEyeX, player->pos.x - 2000.0f, 0.1f, D_80177A48[8], 0.0f);
                gCsCamEyeZ -= 1.0f;
            }
            ...
            if (gCsFrameCount >= 2175) {
                Math_SmoothStepToF(&gCsCamAtZ, gActors[3].obj.pos.z + D_80177D20 - 300.0f, 0.1f, 20.0f, 0.0f);
...
void func_i5_801B28BC(Actor* actor) {
    ...
    switch (actor->state) {
        case 10:
            ...
            break;
        case 11:
            AUDIO_PLAY_SFX(0x09000002, actor->sfxPos, 0);
            actor->timer_0BC = 10;
            actor->state++;
            actor->fwork[29] = 5.0f;
            /* fallthrough */
...
void func_i5_801B3D04(Player* player) {
    ...
    Math_SmoothStepToF(&player->camEye.x, gCsCamEyeX, D_80177A48[0], D_i5_801BE240, 0.0f);
    Math_SmoothStepToF(&player->camEye.y, gCsCamEyeY, D_80177A48[0], D_i5_801BE244, 0.0f);
    Math_SmoothStepToF(&player->camEye.z, gCsCamEyeZ, D_80177A48[0], D_i5_801BE248, 0.0f);
    Math_SmoothStepToF(&player->camAt.x, gCsCamAtX, D_80177A48[0], D_i5_801BE240, 0.0f);
    Math_SmoothStepToF(&player->camAt.y, gCsCamAtY, D_80177A48[0], D_i5_801BE244, 0.0f);
    Math_SmoothStepToF(&player->camAt.z, gCsCamAtZ, D_80177A48[0], D_i5_801BE248, 0.0f);
    player->camAt.y += zeroVar;
