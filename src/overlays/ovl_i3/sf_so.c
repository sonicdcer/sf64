...
void func_i3_801A7930(Player* player) {
    ...
    switch (player->unk_1D0) {
        ...
        case 4:
            ...
            if (gCsFrameCount == 0x618) {
                func_800A6148();
            }
            if (gCsFrameCount >= 0x5FB) {
                D_80178358 = 0xFF;
