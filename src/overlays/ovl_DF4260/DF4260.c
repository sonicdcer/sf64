...
s32 func_DF4260_8018A434(s32 arg0, s32* arg1, s32 arg2, Vec3f* arg3, Boss* arg4) {
    s32 pad;

    if (arg4->swork[arg0] == 0x3E8) {
        *arg1 = 0;
    }
    ...
    switch (arg0) {
        ...
        case 3:
            ...
            break;
        case 1:
            arg3->x += arg4->fwork[4] - D_DF4260_8019B714;
            arg3->y += arg4->fwork[4];
            break;
        case 2:
            arg3->x += arg4->fwork[3] + D_DF4260_8019B714;
            arg3->y += arg4->fwork[3];
            break;
        case 16:
    ...
    if ((arg4->swork[arg0] & 1) || (arg4->timer_05C & 1)) {
        RCP_SetupDL_64();
        GPC(64, 64, 255, 255);
    }
    return 0;
...
s32 func_DF4260_8018AB08(s32 arg0, Gfx** arg1, Vec3f* arg2, Vec3f* arg3, Boss* arg4) {
    if (arg0 == 1) {
...
void func_DF4260_8018DDAC(Boss* arg0) {
    ...
    switch (arg0->unk_04E) {
        ...
        case 1:
            ...
            if (!(gFrameCount & 1)) {
                Matrix_MultVec3f(gCalcMatrix, &D_DF4260_80199A6C, &sp4C);
                func_8007C120(arg0->obj.pos.x + sp4C.x, arg0->obj.pos.y + sp4C.y, arg0->obj.pos.z + sp4C.z, arg0->vel.x, arg0->vel.y, arg0->vel.z, 0.2f, 0xA);
            }
...
s32 func_DF4260_8018EC54(s32 arg0, Gfx** arg1, Vec3f* arg2, Vec3f* arg3, void* arg4) {
    if ((arg0 == 0xA) && (gBosses[2].unk_04E != 0) && (gBosses[3].unk_04E != 0)) {
        *arg1 = NULL;
    }
...
void func_DF4260_8018ED78(Boss* arg0) {
    ...
    Animation_GetFrameData(&D_602D400, 0, ((Boss*)(arg0))->vwork);
    Animation_DrawSkeleton(1, &D_602D5AC, ((Boss*)(arg0))->vwork, func_DF4260_8018ED1C, NULL, &arg0->index, &gIdentityMatrix);
}
...
void func_DF4260_8018F880(Player* player) {
    ...
    switch (player->unk_1D0) {
        ...
        case 2:
            ...
            if (player->timer_1F8 == 0x14) {
                func_800BA808(gMsg_ID_2010, 0);
            }
            if (player->timer_1F8 == 0) {
                player->unk_1D0 = 3;
                player->timer_1F8 = 0xB4;
                player->unk_004 = 0.0f;
                obj_2f4_0->unk_0B8 = 0;
                obj_2f4_2->unk_0B8 = 0;
                obj_2f4_1->unk_0B8 = 0;
        ...
        case 4:
            ...
            if (player->timer_1F8 == 0x50) {
                func_800BA808(gMsg_ID_2020, 0xA);
            }
            if (player->timer_1F8 < 0x64) {
        ...
        case 8:
            ...
            if (player->timer_1F8 == 0x3C) {
                obj_2f4_1->unk_188 = 5.0f;
            }
            if (player->timer_1F8 == 0x28) {
                obj_2f4_2->unk_188 = 5.0f;
            }
            if ((player->timer_1F8 >= 0x47) && (player->timer_1F8 < 0x50)) {
                obj_2f4_0->unk_07C = 2;
            }
            if ((player->timer_1F8 >= 0x33) && (player->timer_1F8 < 0x3C)) {
                obj_2f4_1->unk_07C = 2;
            }
            if ((player->timer_1F8 >= 0x1F) && (player->timer_1F8 < 0x28)) {
                obj_2f4_2->unk_07C = 2;
            }
            if (player->timer_1F8 == 0x46) {
                obj_2f4_0->unk_0B8 = 1;
                func_800A6028(&player->unk_460, 0x09000002);
            }
            if (player->timer_1F8 == 0x32) {
                obj_2f4_1->unk_0B8 = 2;
                func_800A6028(&player->unk_460, 0x09000002);
            }
