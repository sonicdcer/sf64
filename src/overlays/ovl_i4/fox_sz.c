...
void func_i4_80199900(Actor* actor, s32 arg1) {
    ...
    if (arg1 != 0) {
        ...
        if ((D_i4_801A0560 >= 6) &&
            ...
            AUDIO_PLAY_SFX(0x11030010U, gActors[0].sfxPos, 0U);
            AUDIO_PLAY_SFX(0x31024059U, gActors[0].sfxPos, 0U);
...
void func_i4_80199FCC(Actor* actor, s32 arg1) {
    ...
    AUDIO_PLAY_SFX(0x3103A061U, actor->sfxPos, 4U);
}
...
void func_i4_8019A1D0(void) {
    ...
    AUDIO_PLAY_SFX(0x31000011U, actor->sfxPos, 4U);
}
    ...
    if (((actor->timer_0C0 == 0) && (gPlayer[0].state_1C8 != PLAYERSTATE_1C8_0)) &&
        ...
        for (i = 0; i < 20; i++, actorPtr++) {
            if (actorPtr->obj.status == 0) {
                ...
                AUDIO_PLAY_SFX(0x31000011U, actorPtr->sfxPos, 4U);
                actor->unk_04E++;
                break;
            }
        }
...
void func_i4_8019AB8C(Actor* actor) {
    ...
    switch ((s32) actor->state) {
        ...
        case 10:
            ...
            switch (actor->timer_0BC) {
                case 9800:
                    AUDIO_PLAY_SFX(0x09000002U, gActors[10].sfxPos, 0U);
...
void func_i4_8019BA64(Player* player) {
    ...
    switch (player->unk_1D0) {
        ...
        case 2:
            ...
            if (gCsFrameCount == 500) {
                ...
                for (i = 0; i < 4; i++) {
                    Object_Kill(&gActors[i + 30].obj, gActors[i + 30].sfxPos);
                }
    ...
    switch (gCsFrameCount) {
        case 20:
            AUDIO_PLAY_SFX(0x49000014U, gDefaultSfxPos, 4U);
            break;
...
void func_i4_8019C85C(Player* player) {
    ...
    switch (player->unk_1D0) {
        ...
        case 0:
            ...
            AUDIO_PLAY_SFX(0x31024059U, boss0->sfxPos, 0U);
            break;
...
void func_i4_8019E234(Actor* actor) {
    ...
    if (actor->unk_0D0 != 0) {
        ...
        AUDIO_PLAY_SFX(0x2903300EU, actor->sfxPos, 4U);
        if (actor->health <= 0) {
...
void func_i4_8019E454(Boss* boss) {
    ...
    if (boss->dmgType == DMG_UNK_100) {
        ...
        boss->timer_052 = 60;
        boss->state = 1;
        AUDIO_PLAY_SFX(0x1900404FU, boss->sfxPos, 0U);
    }
...
void func_i4_8019EA68(void) {
    ...
    AUDIO_PLAY_SFX(0x11030010U, boss->sfxPos, 0U);
}
