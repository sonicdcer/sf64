...
ObjectInfo gObjectInfo[] = {
  ...
  /* OBJ_BOSS_KA */  {(void*) Katina_KaSaucerer_Draw, 1, (ObjectFunc) Katina_KaSaucerer_Update,        aKaSaucererHitbox,     0.0f,  0, 0, 40, 0,   0.0f, 10 },
  /* OBJ_BOSS_KA_BASE */  {(void*) Katina_KaFrontlineBase_Draw, 1, (ObjectFunc) Katina_KaFrontlineBase_Update,        aKaFrontlineBaseHitbox,     0.0f,  0, 0, 40, 1,   0.0f, 10 },
