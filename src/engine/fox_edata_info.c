...
ObjectInfo D_edata_800CC124[0x190] = {
  ...
  /* OBJ_80_1,   */  {(void*)     D_CO_602E9E0, 0, (ObjectFunc)          NULL,       gNoHitbox,  2000.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_80_2,   */  {(void*)     D_CO_601BEC0, 0, (ObjectFunc)          NULL,       gNoHitbox,  3000.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_80_3,   */  {(void*)     D_CO_602E7A0, 0, (ObjectFunc)          NULL,       gNoHitbox,  3000.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_80_4,   */  {(void*)     D_CO_60244A0, 0, (ObjectFunc)          NULL,       gNoHitbox,  3000.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_80_5,   */  {(void*)     D_CO_602E570, 0, (ObjectFunc)          NULL,       gNoHitbox,  3000.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_80_8,   */  {(void*)     D_CO_60164F0, 0, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_80_9,   */  {(void*)     D_CO_6014500, 0, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_80_39,  */  {(void*) Obj39_Draw, 1, (ObjectFunc) Obj39_Update,       gNoHitbox,  6000.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_80_62,  */  {(void*)     D_MA_60270E0, 0, (ObjectFunc)          NULL,       gNoHitbox,  1500.0f,  0, 0,  0, 0,   0.0f,  0 },
  ...
  /* OBJ_80_76,  */  {(void*)     D_MA_60075D0, 0, (ObjectFunc)          NULL,       gNoHitbox,  1000.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_77,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,        D_MA_6036344,   200.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_78,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   200.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_79,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   200.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_80,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   200.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_81,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   200.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_82,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   200.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_83,  */  {(void*) Macbeth_801A3240, 1, (ObjectFunc) Macbeth_801A2DD8,       gNoHitbox, 15000.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_84,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_85,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_86,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_87,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_88,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_89,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_90,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_91,  */  {(void*) Macbeth_801A2B24, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_92,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_93,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,   500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_94,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox, 15000.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_95,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox, 15000.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_96,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_97,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox, 15000.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_98,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox, 15000.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_99,  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_100  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_101  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_102  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_103  */  {(void*) Macbeth_801A23AC, 1, (ObjectFunc)          NULL,       gNoHitbox,  2500.0f,  0, 0,  0, 0,   0.0f,  0 },
  ...
  /* OBJ_80_111  */  {(void*) Obj111_Draw, 1, (ObjectFunc)          NULL,       gNoHitbox,  2000.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_80_112  */  {(void*)     D_SY_600F6C0, 0, (ObjectFunc) SectorY_801A52B8,        D_SY_60347F0,  4000.0f,  0, 0, 41, 0,   0.0f,  0 },
  /* OBJ_80_113  */  {(void*)     D_SY_601B610, 0, (ObjectFunc)          NULL,       gNoHitbox,  2000.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_80_114  */  {(void*)     D_SY_601C6A0, 0, (ObjectFunc)          NULL,       gNoHitbox,  2000.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_80_124  */  {(void*)     D_AQ_600EEF0, 0, (ObjectFunc)          NULL,       gNoHitbox,  2000.0f,  0, 0, 41, 0,   0.0f,  0 },
  /* OBJ_80_125  */  {(void*)     D_AQ_600BF80, 0, (ObjectFunc)          NULL,        D_AQ_6030E68,  2000.0f,  0, 0, 41, 0,   0.0f,  0 },
  /* OBJ_80_126  */  {(void*) Aquas_801BE1FC, 1, (ObjectFunc)          NULL,       gNoHitbox,  2000.0f,  0, 0, 41, 0,   0.0f,  0 },
  ...
  /* OBJ_80_137  */  {(void*)     D_VE2_6004170, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0,  0, 1,   0.0f,  0 },
  ...
  /* OBJ_80_140  */  {(void*)     D_versus_30173C0, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_80_141  */  {(void*)     D_versus_30174E0, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_80_147  */  {(void*)          NULL, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0,  0, 0,   0.0f,  0 },
  ...
  /* OBJ_80_155  */  {(void*)          NULL, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
