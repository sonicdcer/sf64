...
ObjectInfo gObjectInfo[] = {
  ...
  /* OBJ_SCENERY_CO_TOWER,  */  {(void*)     aCoTowerDL, 0, (ObjectFunc)          NULL,        D_CO_603E118,   100.0f,  0, 0, 39, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_ARCH_1,  */  {(void*)     D_CO_601F5A0, 0, (ObjectFunc)          NULL,        D_CO_603E14C,   500.0f,  0, 0, 39, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_ARCH_2,  */  {(void*)     D_CO_60137B0, 0, (ObjectFunc)          NULL,        D_CO_603E1B4,   400.0f,  0, 0, 39, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_ARCH_3,  */  {(void*)     D_CO_6006A80, 0, (ObjectFunc)          NULL,        D_CO_603E21C,   400.0f,  0, 0, 39, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_RADAR,  */  {(void*)     D_CO_6016270, 0,    (ObjectFunc)          NULL,        D_CO_603E4A0,   200.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_HIGHWAY_5,  */  {(void*)     D_CO_6010E00, 0, (ObjectFunc)          NULL,        D_CO_603E9EC,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_HIGHWAY_6,  */  {(void*)     D_CO_6014670, 0, (ObjectFunc)          NULL,        D_CO_603EA08,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_HIGHWAY_7,  */  {(void*)     D_CO_6010A50, 0, (ObjectFunc)          NULL,        D_CO_603EA74,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_HIGHWAY_8,  */  {(void*)     D_CO_60143E0, 0, (ObjectFunc)          NULL,        D_CO_603EAE0,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_CO_HIGHWAY_9,  */  {(void*)     D_CO_6014A20, 0, (ObjectFunc)          NULL,        D_CO_603EB0C,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_SCENERY_40,  */  {(void*) Scenery40_Draw, 1, (ObjectFunc) Scenery40_Update,        D_CO_603E4A4,  1000.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_41,  */  {(void*) Scenery41_Draw, 1, (ObjectFunc) SceneryRotateTowardsCamera,        D_CO_603E4DC,   300.0f,  0, 0, 40, 0,   0.0f,  0 },
