...
ObjectInfo gObjectInfo[] = {
  ...
  /* OBJ_SCENERY_AQ_BUMP_1  */  {(void*)     aAqBump1DL, 0, (ObjectFunc)          NULL,       gNoHitbox,  2000.0f,  0, 0, 41, 0,   0.0f,  0 },
  ...
  /* OBJ_SCENERY_AND_PATH_WALLS  */  {(void*) D_VE2_6006890, 0, (ObjectFunc)          NULL,        D_ANDROSS_C038B40,     0.0f,  0, 0, 41, 1,   0.0f,  0 },
  /* OBJ_SCENERY_AND_PATH_EXIT  */  {(void*)     D_VE2_6002990, 0, (ObjectFunc)          NULL,        D_ANDROSS_C038B40,     0.0f,  0, 0, 41, 1,   0.0f,  0 },
  /* OBJ_SCENERY_AND_PATH_ENTRANCE  */  {(void*)     D_VE2_6004170, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0,  0, 1,   0.0f,  0 },
  /* OBJ_SCENERY_VS_BUILDING_1  */  {(void*)     D_versus_3017600, 0, (ObjectFunc)          NULL,        D_versus_302EE64,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_BUILDING_2  */  {(void*)     D_versus_3017600, 0, (ObjectFunc)          NULL,        D_versus_302EE80,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_PYRAMID_1  */  {(void*)     D_versus_30173C0, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_PYRAMID_2  */  {(void*)     D_versus_30174E0, 0, (ObjectFunc)          NULL,       gNoHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_ARCH  */  {(void*)     D_versus_301B080, 0, (ObjectFunc)          NULL,        D_versus_302EE9C,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_KA_FLBASE  */  {(void*)     D_versus_3016B00, 0, (ObjectFunc)          NULL,        D_versus_302EE00,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_SPACE_JUNK_1  */  {(void*)     D_versus_3013780, 0, (ObjectFunc)          NULL,        D_versus_302ED4C,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_SPACE_JUNK_2  */  {(void*)     D_versus_3013580, 0, (ObjectFunc)          NULL,        D_versus_302ED98,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VS_SPACE_JUNK_3  */  {(void*)     D_versus_3012ED0, 0, (ObjectFunc)          NULL,        D_versus_302EDB4,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_SCENERY_154  */  {(void*)     aKaFLBaseDL, 0, (ObjectFunc)          NULL,        aKaFrontlineBaseHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_ACTOR_MA_LOCOMOTIVE */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_Locomotive_Update,        aMaLocomotiveHitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TRAIN_CAR_1 */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_TrainCar1_Update,        aMaTrainCar1Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_207 */  {(void*) Macbeth_Actor207_Draw, 2, (ObjectFunc) Macbeth_Actor207_Update,        aMaActor207Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TRAIN_CAR_2 */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_TrainCar2_Update,        aMaTrainCar2Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TRAIN_CAR_3 */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_TrainCar3_Update,        aMaTrainCar3Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TRAIN_CAR_4 */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_TrainCar4_Update,        aMaTrainCar4Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TRAIN_CAR_5 */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_TrainCar5_Update,        aMaTrainCar5Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TRAIN_CAR_6 */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_TrainCar6_Update,        aMaTrainCar6Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TRAIN_CAR_7 */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_TrainCar7_Update,        aMaTrainCar7Hitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_RAILROAD_SWITCH */  {(void*) Macbeth_RailroadSwitch_Draw, 1, (ObjectFunc) Macbeth_RailroadSwitch_Update,        aMaRailroadSwitchHitbox,   300.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_BOULDER */  {(void*) Macbeth_Boulder_Draw, 1, (ObjectFunc) Macbeth_Boulder_Update,        aMaBoulderHitbox,   300.0f,  0, 1, 40, 1,   0.0f,  1 },
  /* OBJ_ACTOR_MA_HORIZONTAL_LOCK_BAR */  {(void*) Macbeth_HorizontalLockBar_Draw, 1, (ObjectFunc) Macbeth_HorizontalLockBar_Update,        aMaHorizontalLockBarHitbox,   200.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_VERTICAL_LOCK_BAR */  {(void*) Macbeth_VerticalLockBar_Draw, 1, (ObjectFunc) Macbeth_VerticalLockBar_Update,        aMaVerticalLockBarHitbox,   200.0f,  0, 0, 40, 1,   0.0f,  0 },
  ...
  /* OBJ_ACTOR_MA_SPEAR */  {(void*) Macbeth_Spear_Draw, 1, (ObjectFunc) Macbeth_Spear_Update,        aMaSpearHitbox,   300.0f,  0, 0, 40, 1,   1.0f,  0 },
  /* OBJ_ACTOR_MA_SHOCK_BOX */  {(void*) Macbeth_ShockBox_Draw, 1, (ObjectFunc) Macbeth_ShockBox_Update,        aMaShockBoxHitbox,   300.0f,  0, 0, 40, 1,   1.0f,  0 },
  /* OBJ_ACTOR_MA_RAILWAY_SIGNAL */  {(void*) Macbeth_RailwaySignal_Draw, 1, (ObjectFunc) Macbeth_RailwaySignal_Update,        aMaRailwaySignalHitbox,   300.0f,  0, 0, 40, 1,   0.0f,  0 },
  ...
  /* OBJ_ACTOR_TI_DESERT_ROVER */  {(void*) Titania_DesertRover_Draw, 1, (ObjectFunc) Titania_DesertRover_Update,        aTiDesertRoverHitbox,   300.0f,  0, 0, 39, 1,  70.0f,  1 },
  ...
  /* OBJ_ACTOR_TI_FEKUDA */  {(void*) Titania_Fekuda_Draw, 1, (ObjectFunc) Titania_Fekuda_Update,        aTiFekudaHitbox,   200.0f,  0, 0, 39, 1,   1.0f,  1 },
  ...
  /* OBJ_BOSS_CO_CARRIER_LEFT */  {(void*) Corneria_CarrierLeft_Draw, 1, (ObjectFunc) Corneria_CarrierLeft_Update,        aCoCarrierLeftHitbox, 20000.0f,  0, 0, 40, 0,   0.0f, 10 },
  /* OBJ_BOSS_CO_CARRIER_UPPER */  {(void*) Corneria_CarrierUpper_Draw, 1, (ObjectFunc) Corneria_CarrierUpper_Update,        aCoCarrierUpperHitbox, 20000.0f,  0, 0, 40, 0,   0.0f, 10 },
  /* OBJ_BOSS_CO_CARRIER_BOTTOM */  {(void*) Corneria_CarrierBottom_Draw, 1, (ObjectFunc) Corneria_CarrierBottom_Update,        aCoCarrierBottomHitbox, 20000.0f,  0, 0, 40, 0,   0.0f, 10 },
