        ...
        case LEVELTYPE_PLANET:
            ...
            switch (levelId) {
                ...
                case LEVEL_VERSUS:
                    ...
                    Matrix_Translate(gGfxMatrix, sp13C, -2000.0f + bgYpos, -6000.0f, MTXF_APPLY);
                ...
                case LEVEL_TITANIA:
                    ...
                    if ((gCurrentLevel == LEVEL_TITANIA) && (gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_INTRO) &&
                        (gPlayer[0].csState < 3)) {
                        D_bg_8015F968 += __sinf(gPlayer[0].camYaw) * 20.0f;
                        sp13C += D_bg_8015F968;
                    }
                    if ((gCurrentLevel == LEVEL_SOLAR) && (gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_INTRO) &&
                    ...
                    if ((gCurrentLevel == LEVEL_TITANIA) || (gCurrentLevel == LEVEL_ZONESS)) {
                        Matrix_Translate(gGfxMatrix, sp13C, -3000.0f + bgYpos, -7000.0f, MTXF_APPLY);
                    } else if (gCurrentLevel == LEVEL_SOLAR) {
                        Matrix_Translate(gGfxMatrix, sp13C, -3500.0f + bgYpos, -7000.0f, MTXF_APPLY);
                    } else if (gCurrentLevel == LEVEL_MACBETH) {
                        Matrix_Translate(gGfxMatrix, sp13C, -4000.0f + bgYpos, -7000.0f, MTXF_APPLY);
                    }
                    Matrix_SetGfxMtx(&gMasterDisp);
            ...
            if (gPlayer[0].state_1C8 != PLAYERSTATE_ENTER_WARP_ZONE) {
                ...
                if (((sp12C < 45.0f) || (sp12C > 315.0f)) && ((sp130 < 40.0f) || (sp130 > 325.0f))) {
                    ...
                    if (levelId == LEVEL_SECTOR_X) {
                        ...
                        if ((gPlayer[0].state_1C8 != PLAYERSTATE_LEVEL_COMPLETE) || (gPlayer[0].csState < 10)) {
                    ...
                    switch (levelId) {
                        ...
                        case LEVEL_METEO:
                            if ((gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_COMPLETE) && (gCsFrameCount > 260)) {
                        ...
                        case LEVEL_BOLSE:
                            sp128 = 1.0f;
                            if ((gCsFrameCount > 500) && (gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_COMPLETE)) {
                                sp128 = 1.3f;
                            }
                            Matrix_Translate(gGfxMatrix, bgXpos - 120.0f, -(bgYpos - 120.0f), -290.0f, MTXF_APPLY);
                            Matrix_Scale(gGfxMatrix, sp128, sp128, sp128, MTXF_APPLY);
...
void Background_DrawSun(void) {
    ...
    if (((gCurrentLevel == LEVEL_AQUAS) && (gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_INTRO)) ||
        (((gPlayer[gPlayerNum].state_1C8 == PLAYERSTATE_U_TURN) || (gLevelMode == LEVELMODE_ALL_RANGE) ||
          (gPlayer[gPlayerNum].state_1C8 == PLAYERSTATE_LEVEL_COMPLETE)) &&
    ...
    switch (gCurrentLevel) {
        ...
        case LEVEL_AQUAS:
            ...
            if ((D_bg_8015F964 != 0) || (gAqDrawMode == 0)) {
                ...
                if ((gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_INTRO) && (gPlayer[0].csState < 2)) {
                    gDPSetPrimColor(gMasterDisp++, 0x00, 0x00, 255, 255, 255, 255);
                } else if (gPlayer[0].state_1C8 == PLAYERSTATE_LEVEL_COMPLETE) {
