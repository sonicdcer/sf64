...
bool AllRange_PlayMessage(u16* msg, RadioCharacterId rcid) {
    if ((gRadioState == 0) && (gPlayer[0].state_1C8 != PLAYERSTATE_STANDBY)) {
...
void ActorAllRange_PlayMessage(u16* msg, RadioCharacterId character) {
    if (!gHideRadio && (gActors[0].state == STATE360_2) && (gPlayer[0].state_1C8 != PLAYERSTATE_STANDBY)) {
...
void ActorAllRange_SpawnSupplies(Actor* this) {
    ...
    if ((gPlayer[0].state_1C8 == PLAYERSTATE_ACTIVE) && !gAllRangeSuppliesSent) {
...
void ActorAllRange_UpdateEvents(Actor* this) {
    if ((gPlayer[0].state_1C8 == PLAYERSTATE_DOWN) || (gPlayer[0].state_1C8 == PLAYERSTATE_NEXT)) {
...
void ActorAllRange_CheckPlayerNearby(ActorAllRange* this) {
    if ((gPlayer[0].state_1C8 == PLAYERSTATE_ACTIVE) && (this->iwork[24] != 0) &&
                ...
                if (this->aiIndex == AI360_FOX) {
                    if (gCurrentLevel != LEVEL_VENOM_2) {
                        if ((gPlayer[0].somersault && (this->iwork[4] > 10)) ||
                            ((gCurrentLevel == LEVEL_BOLSE) && (gPlayer[0].state_1C8 == PLAYERSTATE_STANDBY))) {
                            this->state = STATE360_3;
        ...
        case STATE360_3:
            ...
            if (this->timer_0BC == 0) {
                ...
                if ((gLevelType == LEVELTYPE_SPACE) && (gCurrentLevel != LEVEL_BOLSE)) {
                    ...
                    if ((gCurrentLevel == LEVEL_KATINA) && (gPlayer[0].state_1C8 == PLAYERSTATE_STANDBY)) {
