...
#if ENABLE_60FPS == 1 // Cutscene_EnterWarpZone 
...
void Cutscene_AllRangeMode(Player* player) {
    ...
    gCsFrameCount++;
    Math_SmoothStepToAngle(&player->aerobaticPitch, 0.0f, 0.1f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
    if (gCsFrameCount == 37 MUL_FRAME_FACTOR) {
        gChangeTo360 = true;
    ...
    Math_SmoothStepToF(&player->rot.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToF(&player->rot.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToF(&player->rot.z, 0.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToF(&player->zRotBank, 0.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToF(&player->camRoll, 0.0f, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToF(&player->boostSpeed, 0.0f, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToF(&player->camDist, 0.0f, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.0f);
    ...
    switch (player->csState) {
        ...
        case 1:
            ...
            Math_SmoothStepToF(&D_ctx_80177A48[1], 360.0f, 0.05f DIV_FRAME_FACTOR, 1.5f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&D_ctx_80177A48[2], -70.0f, 0.1f DIV_FRAME_FACTOR, 0.7f DIV_FRAME_FACTOR, 0.0f);
    ...
    player->pos.z += player->vel.z DIV_FRAME_FACTOR;
    player->trueZpos = player->pos.z + player->camDist;
    player->cam.at.z += player->vel.z DIV_FRAME_FACTOR;
...
#if ENABLE_60FPS == 1 // Cutscene_CoComplete2
void Cutscene_CoComplete2(Player* player) {
    ...
    Math_SmoothStepToF(&player->camRoll, 0.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.01f DIV_FRAME_FACTOR);
    ...
    switch (player->csState) {
        ...
        case 11:
            D_ctx_80177A48[0] = 0.0f;
            Math_SmoothStepToAngle(&player->aerobaticPitch, 0.0f, 1.0f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0f);
            player->cam.at.x += ((gBossDeathCamAtX - player->cam.at.x) * 0.01f) DIV_FRAME_FACTOR;
            player->cam.at.y += ((gBossDeathCamAtY - player->cam.at.y) * 0.01f) DIV_FRAME_FACTOR;
            player->cam.at.z += ((gBossDeathCamAtZ - player->cam.at.z) * 0.01f) DIV_FRAME_FACTOR;
            player->cam.eye.x += ((player->cam.at.x + (500.0f * player->unk_004) - player->cam.eye.x) * 0.01f) DIV_FRAME_FACTOR;
            player->cam.eye.y += ((player->cam.at.y + 500.0f - player->cam.eye.y) * 0.01f) DIV_FRAME_FACTOR;
            player->cam.eye.z += ((gBossDeathCamAtZ + (2000.0f * D_ctx_80177950) - player->cam.eye.z) * 0.01f) DIV_FRAME_FACTOR;

            if (player->csEventTimer > 25) {
                D_ctx_80177A48[2] += (1.5f * player->unk_004) DIV_FRAME_FACTOR;
                Math_SmoothStepToF(&player->rot.z, player->unk_004 * -450.0f * D_ctx_80177950, 0.2f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            } else {
                D_ctx_80177A48[2] += (0.25f * player->unk_004) DIV_FRAME_FACTOR;
                ...
                Math_SmoothStepToF(&player->rot.z, player->unk_004 * 20.0f * D_ctx_80177950, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            }

            if (D_ctx_80177950 > 0.0f) {
                Math_SmoothStepToF(&player->rot.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            } else {
                Math_SmoothStepToF(&player->rot.y, 180.0f, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&player->pos.x, player->cam.eye.x, 1.0f DIV_FRAME_FACTOR, 30.0f DIV_FRAME_FACTOR, 0.0f DIV_FRAME_FACTOR);
                D_ctx_80177A48[2] = 0.0f;
            }

            player->pos.x += D_ctx_80177A48[2] DIV_FRAME_FACTOR;
            Math_SmoothStepToF(&player->rot.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&player->pos.y, player->cam.eye.y + 5.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
        ...
        case 0:
            if (player->csTimer > 60) {
                Math_SmoothStepToF(&player->rot.z, player->unk_004 * 60.0f * D_ctx_80177950, 0.1f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            }
            if (player->csTimer < 80) {
                gCsCamAtX = player->pos.x;
                gCsCamAtY = player->pos.y;
                gCsCamAtZ = player->trueZpos + gPathProgress + 30.0f;
                Math_SmoothStepToF(&D_ctx_80177A48[0], 0.05f, 0.1f DIV_FRAME_FACTOR, 0.0005f DIV_FRAME_FACTOR, 0.0f);
            }

            Math_SmoothStepToF(&player->pos.x, player->cam.eye.x, 0.1f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
            gCsCamEyeY += (((player->cam.at.y + 500.0f) - player->cam.eye.y) * 0.01f) DIV_FRAME_FACTOR;
            ...
            if (player->csEventTimer == 0) {
                Math_SmoothStepToF(&player->rot.y, var_fa1, 0.1f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);
            }

            player->vel.y = 0.0f;
            Math_SmoothStepToF(&player->pos.y, player->cam.eye.y + 5.0f, 0.1f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);

            if (player->csTimer < 40) {
                Math_SmoothStepToF(&player->rot.z, player->unk_004 * 180.0f, 0.1f DIV_FRAME_FACTOR, 1.5f DIV_FRAME_FACTOR, 0.0f);
            }
            if (player->csTimer == 0) {
                player->csState = 1;
                player->csTimer = 150;
        ...
        case 1:
            ...
            player->unk_000 += 0.005f DIV_FRAME_FACTOR;
            if (player->unk_000 > 0.3f) {
                player->unk_000 = 0.3f;
            }
            Math_SmoothStepToF(&gCsCamAtX, player->pos.x, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&gCsCamAtY, player->pos.y, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&gCsCamAtZ, player->trueZpos + gPathProgress + 30.0f, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&player->pos.y, player->cam.eye.y + 5.0f, 0.1f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&player->rot.x, 20.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.01f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&player->pos.x, player->cam.eye.x, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);

            if (player->csTimer <= 110) {
                Math_SmoothStepToF(&player->rot.z, player->unk_004 * 360.0f, 0.1f DIV_FRAME_FACTOR, 2.5f DIV_FRAME_FACTOR, 0.0f);
            } else {
                Math_SmoothStepToF(&player->rot.z, player->unk_004 * 180.0f, 0.1f DIV_FRAME_FACTOR, 2.5f DIV_FRAME_FACTOR, 0.0f);
            }
        ...
        case 2:
            player->pos.y += 5.0f DIV_FRAME_FACTOR;
            ...
            Math_SmoothStepToF(&gCsCamAtX, player->pos.x, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&gCsCamAtY, player->pos.y - D_ctx_80177A48[6], D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&gCsCamAtZ, player->trueZpos + gPathProgress - D_ctx_80177A48[6], D_ctx_80177A48[0] DIV_FRAME_FACTOR,50000.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&D_ctx_80177A48[6], 130.0f, 0.1f DIV_FRAME_FACTOR, 0.25f DIV_FRAME_FACTOR, 0.0f);
            player->unk_000 += 0.002f DIV_FRAME_FACTOR;
            ...
            gCOComplete2CamRotY += player->unk_008 DIV_FRAME_FACTOR;
            Math_SmoothStepToAngle(&player->rot.z, 0.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);

            if (player->csTimer == 0) {
                player->unk_008 += 0.01f DIV_FRAME_FACTOR;
                if (player->unk_008 > 0.63f) {
                    player->unk_008 = 0.63f;
                }
            } else {
                player->unk_008 -= 0.0005f DIV_FRAME_FACTOR;
        ...
        case 4:
            ...
            player->unk_000 += 1.0f DIV_FRAME_FACTOR;
        ...
        case 5:
            gCsCamAtX += D_ctx_80177A48[7] DIV_FRAME_FACTOR;
            gCsCamAtY += D_ctx_80177A48[8] DIV_FRAME_FACTOR;
            gCsCamAtZ += D_ctx_80177A48[9] DIV_FRAME_FACTOR;
            player->draw = false;
            if (player->csTimer == 0) {
                player->state_1C8 = PLAYERSTATE_1C8_NEXT;
                player->csTimer = 0;
    ...
    Math_SmoothStepToF(&player->cam.eye.y, gCsCamEyeY, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0);
    Math_SmoothStepToF(&player->cam.eye.z, gCsCamEyeZ, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0);
    Math_SmoothStepToF(&player->cam.at.x, gCsCamAtX, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.f);
    Math_SmoothStepToF(&player->cam.at.y, gCsCamAtY, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.f);
    Math_SmoothStepToF(&player->cam.at.z, gCsCamAtZ, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 50000.0f DIV_FRAME_FACTOR, 0.f);
...
void Cutscene_UTurn(Player* player) { // 60fps UTURN
    ...
    Math_SmoothStepToF(&player->zRotBarrelRoll, 0.0f, (0.1f DIV_FRAME_FACTOR), (15.0f DIV_FRAME_FACTOR), 0.0f); // 60fps
    Math_SmoothStepToF(&player->rot.z, 0.0f, (0.1f DIV_FRAME_FACTOR), (5.0f DIV_FRAME_FACTOR), 0.0f);
    Math_SmoothStepToF(&player->rot.y, 0.0f, (0.1f DIV_FRAME_FACTOR), (5.0f DIV_FRAME_FACTOR), 0.0f);
    Math_SmoothStepToF(&player->rot.x, 0.0f, (0.1f DIV_FRAME_FACTOR), (5.0f DIV_FRAME_FACTOR), 0.0f);
    ...
    player->boostMeter += 1.0f DIV_FRAME_FACTOR; // 60fps
    ...
    switch (player->csState) {
        ...
        case 2:
            ...
            Math_SmoothStepToF(&player->wings.unk_04, sp58.y, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR,
                               0.0f); // 60fps
            Math_SmoothStepToF(&player->wings.unk_08, sp58.y, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&player->wings.unk_0C, sp58.y, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&player->wings.unk_10, sp58.y, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&player->zRotBank, 0.0f, 0.1f DIV_FRAME_FACTOR, 15.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&player->aerobaticPitch, 190.0f, 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR,
                               0.001f DIV_FRAME_FACTOR);
            ...
            player->unk_004 -= 0.2f DIV_FRAME_FACTOR; // 60fps
            break;

        case 3:
            Math_SmoothStepToF(&player->zRotBank, 0.0f, 0.05f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR,
            ...
            Math_SmoothStepToF(&player->wings.unk_04, sp58.y, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR,
                               0.0f); // 60fps
            Math_SmoothStepToF(&player->wings.unk_08, sp58.y, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR,
                               0.0f); // 60fps

            sp58.z = -sp58.y;

            Math_SmoothStepToF(&player->wings.unk_0C, sp58.z, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR,
                               0.0f); // 60fps
            Math_SmoothStepToF(&player->wings.unk_10, sp58.z, 0.3f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR,
                               0.0f); // 60fps

            player->unk_190 = 2.0f;
            player->cam.eye.x += player->vel.x * 0.1f DIV_FRAME_FACTOR; // 60fps adjustment
            player->cam.eye.z += player->vel.z * 0.1f DIV_FRAME_FACTOR; // 60fps adjustment

            if (player->unk_19C != 0) {
                player->cam.eye.x += player->vel.z * 0.2f DIV_FRAME_FACTOR; // 60fps adjustment
                player->cam.eye.z += player->vel.x * 0.2f DIV_FRAME_FACTOR; // 60fps adjustment
            }

            if (player->unk_19C == 0) {
                Math_SmoothStepToAngle(&player->yRot_114, sp58.x, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR,
                                       0.0f); // 60fps adjustment
            }

            if (player->pos.y < player->pathHeight) {
                if (player->unk_004 < 0.0f) {
                    player->unk_004 += 0.2f DIV_FRAME_FACTOR; // 60fps adjustment
                }
            } else {
                player->unk_004 -= 0.2f DIV_FRAME_FACTOR; // 60fps adjustment
            }
    ...
    player->pos.y += player->unk_004 DIV_FRAME_FACTOR;    // 60fps
    player->cam.at.y += player->unk_004 DIV_FRAME_FACTOR; // 60fps
    player->bankAngle = player->rot.z + player->zRotBank + player->zRotBarrelRoll;
...
#if ENABLE_60FPS == 1 // Cutscene_ArwingDown360
...
#if ENABLE_60FPS == 1 // Cutscene_ArwingDownOnRails *Incomplete! 
void Cutscene_ArwingDownOnRails(Player* player) {
    ...
    if (!((gCurrentLevel == LEVEL_VENOM_ANDROSS) && gBossActive) && (gLevelType == LEVELTYPE_PLANET)) {
        player->vel.y = player->vel.y - (0.5f DIV_FRAME_FACTOR) ;
    }

    player->pos.z += player->vel.z DIV_FRAME_FACTOR;
    player->trueZpos = player->pos.z + player->camDist;
    player->bankAngle = player->rot.z + player->zRotBank + player->zRotBarrelRoll;
    player->zRotBank = player->zRotBank + (15.0f DIV_FRAME_FACTOR);

    if (player->csState != 0) {
        player->rot.y += 14.0f DIV_FRAME_FACTOR;
        player->rot.x += 26.0f DIV_FRAME_FACTOR;
    }

    if (((gGameFrameCount % (2 MUL_FRAME_FACTOR)) == 0)) { // Smoke
        func_effect_8007D24C(RAND_FLOAT_CENTERED(20.0) + player->pos.x, RAND_FLOAT_CENTERED(20.0) + player->pos.y, player->trueZpos, 2.2f);
    }
    ...
    } else if (((player->radioDamageTimer > 0) || (player->pos.y < player->pathFloor) || (player->csEventTimer == 0)) && (player->csTimer == 0)) {
        if (player->pos.y < player->pathFloor) {
            func_effect_8007C688(player->pos.x, gGroundHeight + 20.0f, player->trueZpos - (2.0f * player->vel.z), 3.0f, 800);
            func_enmy_80062C38(player->pos.x, player->pos.z);
        }
        func_effect_8007D0E0(player->pos.x, player->pos.y - (2.0f * player->vel.y), player->trueZpos - (2.0f * player->vel.z), 6.0f);
        func_effect_8007BFFC(player->pos.x, player->pos.y - player->vel.y, player->trueZpos - (2.0f * player->vel.z), 0.0f, 0.0f, 0.0f, 3.0f, 20);
        if (gLevelType == LEVELTYPE_PLANET) {
            for (i = 0; i < 2; i++) {
                Play_SpawnDebris(2, player->pos.x, player->pos.y, player->trueZpos);
            }
    ...
    player->camRoll -= 3.0f DIV_FRAME_FACTOR;

    if (player->csState != 0) {
        player->camRoll += 10.0f DIV_FRAME_FACTOR;
    }
...
#if ENABLE_60FPS == 1 // Cutscene_PlayerDown
...
void func_demo_8004E4D4(ActorCutscene* this) {
    ...
    this->fwork[7] += 3.0f DIV_FRAME_FACTOR;
    this->rot_0F4.z = SIN_DEG(this->fwork[7]) * 1.0f + (0.5f DIV_FRAME_FACTOR);
    this->fwork[8] += 2.0f DIV_FRAME_FACTOR;
    sp34 = SIN_DEG(this->fwork[8]) * 10.0f DIV_FRAME_FACTOR;

    switch (this->state) {
        case 0:
            Math_SmoothStepToF(&this->obj.rot.z, 0.0f, 0.05f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->obj.pos.x, this->fwork[0] + sp38->pos.x, 0.03f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->obj.pos.y, this->fwork[1] + sp38->pos.y + sp34, 0.03f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->obj.pos.z, this->fwork[2] + sp38->trueZpos, 0.03f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
        ...
        case 2:
            if (gLevelType == LEVELTYPE_PLANET) {
                this->fwork[21] += 0.4f DIV_FRAME_FACTOR;
                if (this->fwork[21] > 0.6f) {
                    this->fwork[21] = 0.6f;
                }
            }
            this->iwork[11] = 2;
            this->fwork[9] *= IMPROPER_DIV_FRAME_FACTOR(1.2f);
            if (this->timer_0BC == 0) {
                Object_Kill(&this->obj, this->sfxSource);
            }
            break;
        ...
        case 11:
            this->iwork[11] = 2;
            this->fwork[9] += 2.0f DIV_FRAME_FACTOR;
            ...
            if (this->timer_0BE == 0) {
                switch (this->index) {
                    case 1:
                        this->obj.rot.y += 0.3f DIV_FRAME_FACTOR;
                        Math_SmoothStepToF(&this->obj.rot.z, -70.0f, 0.05f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);
                        break;
                    ...
                    case 3:
                        this->obj.rot.x -= 0.4f DIV_FRAME_FACTOR;
                        Math_SmoothStepToF(&this->obj.rot.z, 1000.0f, 0.05f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.0f);
                        break;
                }
            }
        ...
        case 30:
            this->fwork[3] += D_demo_800CA098[this->index] DIV_FRAME_FACTOR;
            ...
            Math_SmoothStepToF(&this->obj.rot.z, SIN_DEG(this->fwork[3]) * -30.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->obj.pos.x, this->fwork[0] + sp38->pos.x, 0.03f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->obj.pos.y, this->fwork[1] + sp38->pos.y + sp34, 0.03f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->obj.pos.z, this->fwork[2] + sp38->trueZpos, 0.03f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
            break;
        ...
        case 32:
            this->iwork[11] = 2;
            Math_SmoothStepToF(&this->obj.rot.x, -20.0f, 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->fwork[9], 25.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&this->obj.rot.z, 0.0f, 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.0f);
            break;
    }
...
#if ENABLE_60FPS == 1 // func_demo_8004EBD0 *into levels? 
void func_demo_8004EBD0(ActorCutscene* this) {
    ...
    if (this->state < 4) {
        ...
        this->obj.pos.x += ((gCsTeamTargetsX[this->index] - this->obj.pos.x) * 0.4f) DIV_FRAME_FACTOR;
        this->obj.pos.y += ((gCsTeamTargetsY[this->index] - this->obj.pos.y) * 0.4f) DIV_FRAME_FACTOR;
        this->obj.pos.z += ((gCsTeamTargetsZ[this->index] - this->obj.pos.z) * 0.4f) DIV_FRAME_FACTOR;

        this->obj.rot.z *= PROPER_DIV_FRAME_FACTOR(0.98f);
        this->obj.rot.x = -gPlayer[0].rot.x;
        this->obj.rot.y = gPlayer[0].rot.y + 180.0f;

        if (1) {}

        this->fwork[7] += 1.0f DIV_FRAME_FACTOR;
        if (((s32) this->fwork[7] & 0x40) != 0) {
            this->fwork[0] += 0.1f DIV_FRAME_FACTOR;
        } else {
            this->fwork[0] -= 0.1f DIV_FRAME_FACTOR;
        }

        this->fwork[8] += 1.2f DIV_FRAME_FACTOR;
        if (((s32) this->fwork[8] & 0x40) != 0) {
            this->fwork[1] += 0.1f DIV_FRAME_FACTOR;
        } else {
            this->fwork[1] -= 0.1f DIV_FRAME_FACTOR;
        }
    }
    ...
    switch (this->state) {
        case 0:
            this->fwork[3] *= PROPER_DIV_FRAME_FACTOR(0.992f)  ;
        ...
        case 1:
            this->fwork[3] *= PROPER_DIV_FRAME_FACTOR(0.997f)  ;
        ...
        case 4:
            ...
            this->fwork[6] += 1.0f DIV_FRAME_FACTOR;
            ...
            this->vel.x = dest.x DIV_FRAME_FACTOR; //???????
            this->vel.y = dest.y DIV_FRAME_FACTOR; //???????
            this->vel.z = dest.z DIV_FRAME_FACTOR; //???????
    ...
    this->obj.pos.y += 5.0f DIV_FRAME_FACTOR;
    this->fwork[21] -= 0.02f DIV_FRAME_FACTOR;
...
#if ENABLE_60FPS == 1 // func_demo_8004F05C *This fixes the ships cutscene in Cornaria. Needs closer look for other levels.
void func_demo_8004F05C(Actor* actor) {
    if (((gLevelType == LEVELTYPE_PLANET) && (actor->animFrame == 0)) || (gCurrentLevel == LEVEL_BOLSE)) {
        actor->fwork[0] += 3.0f DIV_FRAME_FACTOR;
    ...
    switch (gCurrentLevel) {
            ...
            switch (actor->animFrame) {
                case 0:
                    if (gPlayer[0].state_1C8 == PLAYERSTATE_1C8_LEVEL_INTRO) {
                        actor->rot_0F4.z += actor->rot_0F4.y DIV_FRAME_FACTOR;
                        actor->vel.x = SIN_DEG(actor->rot_0F4.z) * 10.0f;
                        actor->obj.rot.z = SIN_DEG(actor->rot_0F4.z) * 40.0f;
                        break;
                    }

                    Math_SmoothStepToF(&actor->obj.rot.z, actor->fwork[1], 0.05f DIV_FRAME_FACTOR, 0.3f DIV_FRAME_FACTOR, 0.0f);
                    ...
                    switch (actor->state) {
                        ...
                        case 2:
                            actor->iwork[11] = 2;
                            actor->vel.z -= 5.0f DIV_FRAME_FACTOR;
                ...
                case 32:
                    actor->obj.rot.z += actor->rot_0F4.z DIV_FRAME_FACTOR;
                    if (actor->timer_0BC == 0) {
                        Object_Kill(&actor->obj, actor->sfxSource);
                    }
                    break;
                    ...
                    if (actor->timer_0BC == 0) {
                        if (actor->obj.pos.x >= -3500.0f) {
                            if (actor->obj.pos.z <= 3000.0f) {
                                if ((fabsf(actor->obj.pos.y) <= 400.0f) && (gCsFrameCount <= 300 MUL_FRAME_FACTOR)) {
        ...
        case LEVEL_SECTOR_X:
            if ((actor->state != 0) && (actor->state == 1)) {
                actor->vel.y += 0.1f DIV_FRAME_FACTOR;
                Math_SmoothStepToF(&actor->obj.rot.x, -20.0f, 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.0f);
            }
            break;
        ...
        default:
            switch (actor->state) {
                case 100:
                    Math_SmoothStepToF(&actor->obj.pos.x, actor->vwork[0x14].x, 0.03f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&actor->obj.pos.y, actor->vwork[0x14].y, 0.03f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&actor->obj.pos.z, actor->vwork[0x14].z, 0.03f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&actor->obj.rot.z, 0.0f, 0.02f DIV_FRAME_FACTOR, 0.3f DIV_FRAME_FACTOR, 0);
                    break;
                ...
                case 1:
                    actor->vel.y += 0.8f DIV_FRAME_FACTOR;
                    actor->vel.x += 0.8f DIV_FRAME_FACTOR;
                    Math_SmoothStepToF(&actor->obj.rot.z, 420.0f, 0.1f DIV_FRAME_FACTOR, 15.0f DIV_FRAME_FACTOR, 0.001f DIV_FRAME_FACTOR);
                    break;
                ...
                case 3:
                    actor->vel.y += 1.2f DIV_FRAME_FACTOR;
                    actor->vel.z += 0.1f DIV_FRAME_FACTOR;
                    Math_SmoothStepToF(&actor->obj.rot.x, -45.0f, 0.1f DIV_FRAME_FACTOR, 15.0f DIV_FRAME_FACTOR, 0.001f DIV_FRAME_FACTOR);
                    break;

                case 10:
                    actor->vel.x -= 1.0f DIV_FRAME_FACTOR;
                    Math_SmoothStepToF(&actor->obj.rot.z, -45.0f, 0.05f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.0f);
                    break;

                case 11:
                    actor->vel.x -= 2.0f;
                    Math_SmoothStepToF(&actor->obj.rot.z, -70.0f, 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&actor->obj.rot.y, 225.0f, 0.05f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
                    break;

                case 12:
                    actor->vel.x += 2.0f DIV_FRAME_FACTOR;
                    actor->vel.y += 1.0f DIV_FRAME_FACTOR;
                    Math_SmoothStepToF(&actor->obj.rot.z, 80.0f, 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&actor->obj.rot.x, -15.0f, 0.05f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&actor->obj.rot.y, 135.0f, 0.05f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
                    break;

                case 13:
                    actor->vel.y += 2.0f;
                    Math_SmoothStepToF(&actor->obj.rot.z, -400.0f, 0.2f DIV_FRAME_FACTOR, 14.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&actor->obj.rot.x, -45.0f, 0.05f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);
                    break;
            }
            break;
    }
...
#if ENABLE_60FPS == 1 // ActorCutscene_Update
                ...
                case LEVEL_FORTUNA:
                    if (this->animFrame == 11 MUL_FRAME_FACTOR) {
                        switch (this->state) {
                            ...
                            case 1:
                                Math_SmoothStepToF(&this->scale, 0.5f, 0.03f DIV_FRAME_FACTOR, 0.01f DIV_FRAME_FACTOR, 0.0f);
