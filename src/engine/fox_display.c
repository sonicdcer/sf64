...
void func_display_80054300(Player* player) { // player shadows
...
void Play_Draw(void) {
    ...
    if ((gGroundSurface == SURFACE_WATER) && (gPlayer[0].state_1C8 != PLAYERSTATE_1C8_LEVEL_INTRO)) { // player reflection
