    ...
    switch (player->unk_1D0) {
        ...
        case 2:
            ...
            if ((player->timer_1F8 == 0x5F) && (gTeamShields[1] > 0)) {
                ...
                AUDIO_PLAY_SFX(0x0940802AU, gActors[0].sfxPos, 0);
            }

            if ((player->timer_1F8 == 0x5A) && (gTeamShields[3] > 0)) {
                gActors[2].state = var_v0;
                AUDIO_PLAY_SFX(0x0940802AU, gActors[2].sfxPos, 0);
            }

            if ((player->timer_1F8 == 85) && (gTeamShields[2] > 0)) {
                gActors[1].state = var_v0;
                AUDIO_PLAY_SFX(0x0940802AU, gActors[1].sfxPos, 0);
            }
        ...
        case 4:
            ...
            if (player->timer_1F8 == 0) {
                ...
                if (D_80178340 == 255) {
                    ...
                    D_8017827C = 1;
                    D_800CA230 = 0.15f;
                    AUDIO_PLAY_SFX(0x11407079U, gDefaultSfxPos, 0);
                    func_800AB334();
                }
            }
            break;
    ...
    switch (player->unk_1D0) {
        ...
        case 1:
            ...
            if (gCsFrameCount == 0x8A) {
                AUDIO_PLAY_SFX(0x09000007U, player->sfxPos, 0);
            }

            if (gCsFrameCount == 0xBE) {
                AUDIO_PLAY_SFX(0x09000013U, player->sfxPos, 0);
            }
                        ...
                        switch (actor->state) {
                            case 0:
                                if (gCsFrameCount == 0x64) {
                                    ...
                                    actor->timer_0BC = 0x32;
                                    actor->iwork[0] = 255;
                                    AUDIO_PLAY_SFX(0x2902F026U, actor->sfxPos, 0);
                                }
                                break;
