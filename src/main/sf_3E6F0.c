...
// extern s32 D_8015F988[0x67F] // enormous unused space. D_8015F984[0x680] perhaps? Fits the divisible by 13 pattern
extern f32 D_80161394; // can be static

extern f32 D_800C9C30;
extern u16 D_800C9C34;
// D_800C9C38 missing
extern u16 D_800C9C3C[16];
extern Gfx* D_800C9C5C[13];
extern Gfx* D_800C9C90[13];
extern f32 D_800C9CC4[13];
extern f32 D_800C9CF8[13];
extern f32 D_800C9D2C[13];
extern f32 D_800C9D60[13];
extern Color_RGB8 D_800C9D94[13];
extern Color_RGB8 D_800C9DBC[13];
extern s32 D_800C9DE4[13];
extern s32 D_800C9E18[13];
extern s32 D_800C9E4C[2];
extern s32 D_800C9E54[2];
extern f32 D_800C9E5C[2];
extern f32 D_800C9E64[4];
extern f32 D_800C9E74[4];
            ...
            case LEVELTYPE_PLANET:
                ...
                switch (sp11C) {
                    ...
                    case 20:
                        ...
                        Matrix_RotateZ(gGfxMatrix, gPlayer[gPlayerNum].unk_034 * 0.017453292f, 1);
                    ...
                    case 9:
                        if (D_80177AB0 != 6) {
                            if ((D_80177AB0 == 2) || (D_80177AB0 == 7)) {
                                ...
                                gDPSetPrimColor(gMasterDisp++,  0x00, 0x00, 255, (s32)D_80161394, (s32)D_80161394, (s32) D_800C9C30);
                                ...
                                Matrix_RotateZ(gGfxMatrix, (gPlayer->unk_034 + ((f32) gFrameCount * 1.5f)) * 0.017453292f, 1);
                                Matrix_SetGfxMtx(&gMasterDisp);
                                ...
                                if (D_80177AB0 != 5) {
                                    ...
                                    Matrix_RotateZ(gGfxMatrix, (gPlayer->unk_034 + ((f32) gFrameCount * -1.3f)) * 0.017453292f, 1);
                                    Matrix_SetGfxMtx(&gMasterDisp);
                                    gSPDisplayList(gMasterDisp++, D_C039208);
                                    Matrix_Pop(&gGfxMatrix);
                                }
                    ...
                    case 11:
                    case 12:
                        sp13C = (Math_RadToDeg(gPlayer[gPlayerNum].unk_058) - gPlayer[gPlayerNum].unk_114) * -40.44444f * 2.0f;
                        sp134 = (gPlayer[gPlayerNum].unk_05C * -7000.0f) - (gPlayer[gPlayerNum].camEye.y * 0.6f);
                        if ((gCurrentLevel == 0xC) && (gPlayer->state_1C8 == 2) && (gPlayer->unk_1D0 < 3)) {
                            D_8015F968 += __sinf(gPlayer->unk_058) * 20.0f;
                            sp13C += D_8015F968;
                        }
                        if ((gCurrentLevel == 7) && (gPlayer->state_1C8 == 2) && (gPlayer->unk_1D0 >= 2) && (gPlayer->camEye.z <= -1900.0f)) {
...
void func_80040450(void) {
    ...
    if ((gCurrentLevel == 0x10) || (gCurrentLevel == 0x13) || (gCurrentLevel == 9) || (gCurrentLevel == 7) || (gCurrentLevel == 0xA) || gVersusMode) {
        return;
    }
    ...
    if (((gCurrentLevel == 0xD) && (gPlayer->state_1C8 == 2)) || (((gPlayer[gPlayerNum].state_1C8 == 5) || (gLevelMode == LEVELMODE_ALL_RANGE) || (gPlayer[gPlayerNum].state_1C8 == 7)) && (gLevelType == 0) && (gCurrentLevel != 0xC) && (gCurrentLevel != 0xD))) {
        D_80178390[gPlayerNum] = 0x80;
        D_801783A0[gPlayerNum] = 0x80;
        D_801783B0[gPlayerNum] = 0x80;
...
void func_80040954(void) {
    ...
    if ((gCurrentLevel != 9) && (gLevelType != 1) && (D_80178380[gPlayerNum] != 0)) {
        var_fs2 = 1.0f;
        ...
        for(i = 5; i < 13; i++, var_s1++, var_s4++, var_s5++, var_s6++, var_s7++) {
            ...
            if (((i == 5) || (i == 0xB)) && (gCurrentLevel != 0x10)) {
                Matrix_RotateX(gGfxMatrix, 1.5707964f, 1);
            }
            Matrix_SetGfxMtx(&gMasterDisp);
            var_fv0 = *var_s4;
...
void func_80040CE4(void) {
    ...
    case 0:
        ...
        if (gLevelMode == 0) {
            ...
            gDPSetTile(gMasterDisp++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0x0000, G_TX_RENDERTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD);
            gDPSetTileSize(gMasterDisp++, G_TX_RENDERTILE, temp_fv0, temp_s0, 0x007C, 0x007C);
            switch (D_80161A88) {
                case 0:
                    gDPSetTextureImage(gMasterDisp++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, D_601B6C0);
                    gDPTileSync(gMasterDisp++);
                    gDPSetTile(gMasterDisp++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0x0000, G_TX_LOADTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOLOD);
    ...
    case 11:
        ...
        switch(gCurrentLevel) {
            case 6:
                sp1C4 = D_6006750;
                sp1C0 = D_60066D0;
                gDPLoadTextureBlock(gMasterDisp++, sp1C4, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD);
                break;
            case 11:
                sp1C4 = D_602DCB8;
                sp1C0 = D_60306D0;
    ...
    case 13:
        ...
        if ((D_8015F964 == 0) && ((D_80177AC8 == 0) || (D_80177AC8 == 2))) {
            ...
            Matrix_Scale(gGfxMatrix, 1.0f, 1.0f, 0.5f, 1);
            Matrix_SetGfxMtx(&gMasterDisp);
            gSPDisplayList(gMasterDisp++, D_600AB10);
            Matrix_Pop(&gGfxMatrix);
            Matrix_Push(&gGfxMatrix);
            Matrix_Translate(gGfxMatrix, 0.0f, 0.0f, 3000.0f, 1);
            Matrix_Scale(gGfxMatrix, 1.0f, 1.0f, 0.5f, 1);
        ...
        if ((D_8015F964 != 0) || (D_80177AC8 == 0)) {
            ...
            if ((gPlayer->state_1C8 == 2) && (gPlayer->unk_1D0 < 2)) {
                gDPSetPrimColor(gMasterDisp++,  0x00, 0x00, 255, 255, 255, 255);
            } else if (gPlayer->state_1C8 == 7) {
...
void func_80042D38(void) {
    Matrix_Push(&gGfxMatrix);
    Matrix_Translate(gGfxMatrix, gPlayer[gPlayerNum].camEye.x, 2.0f + D_8017847C, gPlayer[gPlayerNum].camEye.z, 1);
    Matrix_Scale(gGfxMatrix, 1.5f, 1.0f, 1.0f, 1);
