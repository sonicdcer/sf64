...
Gfx* D_800D1A40[] = { 0x0400103F, (Gfx*) D_800D1A00, 0xB1020406, 0x00020600, 0xB8000000, 0x00000000 };
...
UnkStruct_D_800D1AEC D_800D1AEC[] = {
    { (u8*) D_500A050, 16, 15, (u8*) D_6000000, 128, 28 },   { D_500A140, 16, 15, (u8*) D_6000000, 96, 28 },
    { (u8*) D_500A140, 16, 15, (u8*) D_6000000, 176, 12 },   { D_500A230, 16, 15, (u8*) D_6000000, 168, 28 },
    { (u8*) D_500A230, 16, 15, (u8*) D_6000000, 168, 28 },   { D_500A230, 16, 15, (u8*) D_6000000, 96, 13 },
    { (u8*) D_500A320, 16, 15, (u8*) D_6000000, 176, 12 },   { D_500A320, 16, 15, (u8*) D_6000000, 112, 13 },
    { (u8*) D_500A320, 16, 15, (u8*) D_6000000, 112, 28 },   { D_500A410, 16, 15, (u8*) D_6000000, 96, 28 },
    { (u8*) D_500A410, 16, 15, (u8*) D_6000000, 160, 28 },   { D_500A410, 16, 15, (u8*) D_6000000, 176, 12 },
    { (u8*) D_500A500, 16, 15, (u8*) D_6000000, 168, 19 },   { D_500A500, 16, 15, (u8*) D_6000000, 104, 28 },
    { (u8*) 0x0500A5F0, 16, 15, (u8*) D_6000D80, 128, 28 },  { 0x0500A5F0, 16, 15, (u8*) D_60012D0, 128, 28 },
    { (u8*) 0x0500A5F0, 16, 15, (u8*) 0x0C000A80, 128, 28 }, { D_5009F60, 16, 15, (u8*) 0x05000D50, 80, 12 },
};
...
void func_8008C390(f32 arg0, f32 arg1, f32 arg2, s32 arg3) {
    u16* D_800D1EC0[] = {
        (u16*) D_5000000, (u16*) D_5000080, (u16*) D_5000100, (u16*) D_5000180, (u16*) D_5000200,
        (u16*) D_5000280, (u16*) D_5000300, (u16*) D_5000380, (u16*) D_5000400, (u16*) D_5000480,
    };
    s32 i;
...
void func_800935E8(Player* player) {
    ...
    Vec3f D_800D2320[] = { { 50.0f, -165.0f, -900.0f },
                           { -100.0f,
    ...
    switch (player->unk_1D0) {
        ...
        case 1:
            if ((player->unk_208 == 0) && (D_80177A80 < 250)) {
        ...
        case 3:
            ...
            if (player->timer_1F8 == 774) {
                Audio_PlaySfx(0x01038026U, &player->unk_460, 0U, &D_800C5D34, &D_800C5D34, &D_800C5D3C);
                D_80177A10[9] = 40;
            }
...
void func_80095604(Player* player) {
    ...
    switch (player->unk_1D0) {
        ...
        case 1:
            ...
            if ((D_80177A80 >= 30) && (D_80177A80 < 90)) {
                D_80177A48[5] -= 0.6f;
        ...
        case 12:
            if ((D_80177A80 >= 380) && (D_80177A80 < 640 + 280)) {
