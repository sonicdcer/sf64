...
s32 func_80060FE4(Vec3f* arg0, f32 arg1) {
    ...
    if ((gAllRangeMode != 1) && (gPlayer[0].unk_1C8 != 2)) {
        return true;
    }
...
void func_80061A4C(void) {
    ...
    for (i = 0; i < ARRAY_COUNT(gObjects8C); i++) {
        if (gObjects8C[i].obj.status == 0) {
            ...
            x = gPlayer[0].unk_074.x + (sp1C * 400.0f) + (5.0f * gPlayer[0].unk_0C0.x);
            sp1C = (Rand_ZeroOne() - 0.5f);
            y = gPlayer[0].unk_074.y + (sp1C * 400.0f) + (5.0f * gPlayer[0].unk_0C0.y);
            z = -D_80177D20 - 500.0f;
            if (D_80177D08 < 0.0f) {
                z = -D_80177D20 + 500.0f;
            }
...
void func_80061B68(void) {
    ...
    for (i = 0; i < ARRAY_COUNT(gObjects8C); i++) {
        if (gObjects8C[i].obj.status == 0) {
            ...
            sp1C = (Rand_ZeroOne() - 0.5f);
            x = gPlayer[0].unk_074.x + (sp1C * 2000.0f) + (5.0f * gPlayer[0].unk_0C0.x);
            y = 0;
            while (y <= D_80177940) {
                sp1C = (Rand_ZeroOne() - 0.5f);
                y = gPlayer[0].unk_074.y + (sp1C * 2000.0f) + (5.0f * gPlayer[0].unk_0C0.y);
            }
...
void func_80061CD0(void) {
    ...
    for (i = 0; i < ARRAY_COUNT(gObjects8C); i++) {
        if (gObjects8C[i].obj.status == 0) {
            sp1C = (Rand_ZeroOne() - 0.5f);
            x = gPlayer[D_801778A0].unk_074.x + (sp1C * 3000.0f) + (5.0f * gPlayer[D_801778A0].unk_0C0.x);
            sp1C = (Rand_ZeroOne() - 0.5f);
            y = gPlayer[D_801778A0].unk_074.y + 1000.0f + (sp1C * 500.0f) + (5.0f * gPlayer[D_801778A0].unk_0C0.y);
...
s32 func_8006351C(s32 index, Vec3f* pos, Vec3f* arg2, s32 arg3) {
    ...
    obj80 = gObjects80;
    for (i = 0; i < ARRAY_COUNT(gObjects80) && gAllRangeMode == 0; i++, obj80++) {
    ...
    if ((arg3 == 0) || (arg3 == 2) || (arg3 == 3)) {
        ...
        for (i = 0; i < ARRAY_COUNT(gObjects2F4); i++, obj2F4++) {
            if ((obj2F4->obj.status >= 2) && (fabsf(pos->x - obj2F4->obj.pos.x) < 1000.0f) &&
                ...
                ((obj2F4->obj.id != OBJ_2F4_197) || (obj2F4->unk_0E4 >= 4)) && (obj2F4->unk_0C2 == 0)) {
...
void func_80063E5C(Object_80* obj80, f32* hitboxData) {
    ...
    for (i = 0, item = gItems; i < ARRAY_COUNT(gItems); i++, item++) {
        if (item->obj.status == 0) {
            ...
            item->obj.status = 1;
            item->obj.id = OBJ_ITEM_CORN_ARCH;
...
void func_80063F58(Item* item) {
    item->unk_68 = item->obj.rot.z * 100.0f;
}
...
void Object_Init(s32 index, s32 objId) {
    ...
    switch (objId) {
        ...
        case OBJ_2F4_202:
            ...
            break;
        case OBJ_2F4_252:
            if (gPlayer[0].unk_074.z < gObjects2F4[index].obj.pos.z) {
...
void func_800656D4(Object_2F4* obj2F4) {
    ...
    if ((spC4 == var_ra) || ((var_ra + 1) == spC4) || ((var_ra + 2) == spC4)) {
        ...
        obj2F4->unk_184 = gPlayer[0].unk_074.y;
        obj2F4->unk_180 = gPlayer[0].unk_074.x;
    }
    if (obj2F4->unk_0BC != 0) {
        ...
        if (item->obj.status == 0) {
            ...
            if ((item->obj.id >= OBJ_ITEM_GOLD_RING) || (item->obj.id == OBJ_ITEM_1UP)) {
                ...
                if (item->obj.id == OBJ_ITEM_WING_REPAIR) {
                    func_80019218(0x1900302B, &item->sfxPos, 0, &D_800C5D34, &D_800C5D34, &D_800C5D3C);
                }
            }
            break;
        }
...
void func_80066254(Object_2F4* obj2F4) {
    ...
    if (gVersusMode) {
        ...
        if ((obj2F4->unk_0D4 == 1) && (obj2F4->info.bonus != 0)) {
            ...
            D_80177850 = 0xF;
            if ((gAllRangeMode == 1) && (D_80161A62 != 0)) {
                switch (D_80161A62) {
                    case 9:
...
void func_80066EF0(Item* item) {
    ...
    if ((gAllRangeMode == 0) && (D_80161680 == 0)) {
        var_fa1 = 900.0f;
...
void func_80067BEC(Item* item) {
    ...
    if (item->unk_46 == 0) {
        ...
        Math_SmoothStepToF(&item->unk_68, 2.5f, 1.0f, 0.5f, 0.0f);
        item->obj.pos.x += (gPlayer[item->unk_4E].unk_074.x - item->obj.pos.x) * 0.5f;
        if (gPlayer[item->unk_4E].unk_1CC == 1) {
            item->obj.pos.y += ((gPlayer[item->unk_4E].unk_074.y + 50.0f) - item->obj.pos.y) * 0.5f;
        } else {
            item->obj.pos.y += (gPlayer[item->unk_4E].unk_074.y - item->obj.pos.y) * 0.5f;
        }
...
void func_80068020(Item* item) {
    ...
    switch (item->unk_46) {
        case 0:
            Math_SmoothStepToF(&item->unk_68, 0.4f, 1.0f, 0.05f, 0.0f);
            func_80066EF0(item);
            func_800671D0(item);
            if (item->unk_4C != 0) {
                item->unk_46 = 1;
                ...
                if (item->obj.id == OBJ_ITEM_SILVER_RING) {
                    ...
                    if (gGoldRingCount[0] == 3) {
                        ...
                        gPlayer[item->unk_4E].heal += 0x20;
                        func_80077240(gPlayer[item->unk_4E].unk_074.x, gPlayer[item->unk_4E].unk_074.y,
            ...
            if ((item->obj.id == OBJ_ITEM_GOLD_RING) && (item->unk_48 == 1)) {
                Object_Kill(&item->obj, &item->sfxPos);
            }
            break;
        case 1:
            if (item->unk_48 > 30) {
                Math_SmoothStepToF(&item->unk_68, 1.0f, 1.0f, 0.06f, 0.0f);
            } else {
                Math_SmoothStepToF(&item->unk_68, 0.0f, 1.0f, 0.06f, 0.0f);
            }
            item->obj.pos.x += (gPlayer[item->unk_4E].unk_074.x - item->obj.pos.x) * 0.5f;
            if (gPlayer[item->unk_4E].unk_1CC == 1) {
                item->obj.pos.y += (gPlayer[item->unk_4E].unk_074.y + 50.0f - item->obj.pos.y) * 0.5f;
            ...
            if ((gPlayer[0].unk_238 != 0) && (gAllRangeMode == 0)) {
...
void func_80068688(Item* item) {
    ...
    if (item->unk_46 > 0) {
        if (item->unk_46 == 1) {
            ...
            item->obj.pos.x += (gPlayer[item->unk_4E].unk_074.x - item->obj.pos.x) * 0.3f;
            item->obj.pos.y += (gPlayer[item->unk_4E].unk_074.y - item->obj.pos.y) * 0.3f;
        ...
        if (D_80177E80 < 0) {
            ...
            item->unk_46 = 1;
            item->unk_44 = 0xFF;
            gPlayer[item->unk_4E].unk_27C = 100;
...
void func_80068914(Item* item) {
    ...
    if (item->unk_46 > 0) {
        ...
        item->obj.pos.x += (gPlayer[item->unk_4E].unk_074.x - item->obj.pos.x) * 0.3f;
        if (gPlayer[item->unk_4E].unk_1CC == 1) {
            item->obj.pos.y += (gPlayer[item->unk_4E].unk_074.y + 50.0f - item->obj.pos.y) * 0.3f;
        } else {
            item->obj.pos.y += (gPlayer[item->unk_4E].unk_074.y - item->obj.pos.y) * 0.3f;
        }
        ...
        if (item->unk_48 == 0) {
            Math_SmoothStepToF(&item->unk_68, 5.0f, 0.2f, 15.0f, 0.01f);
...
void func_80068C88(Item* item) {
    ...
    if (gPlayer[0].unk_1C8 != 3) {
        ...
        if (((item->obj.pos.z + D_80177D20) > -2700.0f) && (fabsf(item->obj.pos.x - gPlayer[0].unk_074.x) < 1000.0f)) {
            switch (item->obj.id) {
                case OBJ_ITEM_331:
                case OBJ_ITEM_332:
                case OBJ_ITEM_333:
        ...
        if (item->unk_4C != 0) {
            ...
            gPlayer[0].unk_210 = item->unk_68 * 0.05f;
            switch (item->obj.id) {
                case OBJ_ITEM_328:
                    if (item->obj.pos.x < gPlayer[0].unk_074.x) {
                        gPlayer[0].unk_118 = -30.0f;
                        gPlayer[0].unk_0B8 = gPlayer[0].unk_0AC + item->unk_68;
                    } else {
                        gPlayer[0].unk_118 = 30.0f;
                        gPlayer[0].unk_0B8 = gPlayer[0].unk_0AC - item->unk_68;
                    }
                ...
                case OBJ_ITEM_330:
                    ...
                    break;
                case OBJ_ITEM_331:
                    if (item->obj.pos.y < gPlayer[0].unk_074.y) {
                        gPlayer[0].unk_124 = 30.0f;
                        gPlayer[0].unk_0BC = gPlayer[0].unk_0B0 + item->unk_68;
                    } else {
                        gPlayer[0].unk_124 = -30.0f;
                        gPlayer[0].unk_0BC = gPlayer[0].unk_0B0 - item->unk_68;
                    }
...
void func_800693E8(Object_2F4* obj2F4) {
    ...
    if ((D_80161AB8 != 0) && (obj2F4->obj.id != OBJ_2F4_198) &&
        ...
        if (((gPlayer[0].unk_040.z + obj2F4->info.unk_10) < (obj2F4->obj.pos.z + D_80177D20)) ||
...
void func_80069658(Object_408* obj408) {
    ...
    if ((D_80161AB8 != 0) && ((obj408->obj.pos.z + D_80177D20) > (obj408->info.unk_10 - gPlayer[0].unk_040.z))) {
...
void func_800696F8(Object_80* obj80) {
    ...
    } else if ((gAllRangeMode == 0) && (D_80178284 != 2)) {
...
void func_80069924(Object_8C* obj8C) {
    ...
    if (D_80161AB8 != 0) {
        if ((gPlayer[0].unk_040.z + obj8C->info.unk_10) < (obj8C->obj.pos.z + D_80177D20)) {
...
void Object_2F4_Update(Object_2F4* obj2F4) {
    ...
    if (gVersusMode) {
        ...
        if (!(gControllerHold[D_80177AF8].button & A_BUTTON)) {
            obj2F4->unk_0CA[0]--;
        }
        D_801779C8[0] = 0;
    }
...
void func_8006A06C(UnkEntity30* unkEnt30) {
    ...
    if (gGameState == GSTATE_PLAY) {
        if (((unkEnt30->mode == 1) || (unkEnt30->mode == 0x65) || (unkEnt30->mode == 0x32)) &&
            ...
            sp44.x = gPlayer[D_801778A0].unk_074.x - unkEnt30->unk_04.x;
            sp44.y = gPlayer[D_801778A0].unk_074.y - unkEnt30->unk_04.y;
        ...
        if (((unkEnt30->unk_04.z + D_80177D20) > 1000.0f) && (gAllRangeMode != 1)) {
            unkEnt30->mode = 0;
        }
...
void Object_UpdateAll(void) {
    ...
    D_80161AB8 = 0;
    if ((gAllRangeMode == 0) && ((gPlayer[0].unk_1C8 == 1) || (gPlayer[0].unk_1C8 == 3) || (gPlayer[0].unk_1C8 == 4) ||
