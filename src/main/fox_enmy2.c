...
void func_8006AC08(Actor* actor) {
    ...
    if (func_8006ABA4(actor) && (actor->timer_0BC == 0)) {
        func_8007F11C(OBJ_8C_353, actor->obj.pos.x, actor->obj.pos.y, actor->obj.pos.z, D_80177828);
        actor->timer_0BC = 20;
    }
...
void func_8006AD18(Actor* actor) {
    ...
    if (!(gFrameCount & 0x1F)) {
        func_8007F11C(OBJ_8C_353, actor->obj.pos.x, actor->obj.pos.y + 180.0f, actor->obj.pos.z, D_80177828);
    }
...
void func_8006D36C(Actor* actor) {
    ...
    switch (temp_s1[actor->unk_0E6] & 0xFE00) {
        ...
        case 0xD000:
            ...
            actor->unk_0CE = temp_s1[actor->unk_0E6] & 0x1FF;
            actor->unk_0E6 += 2;
        ...
        case 0xF200:
            if (actor->iwork[12] == temp_s1[actor->unk_0E6 + 1]) {
                actor->unk_0D0 = 1;
                actor->unk_0D6 = temp_s1[actor->unk_0E6] & 0x1FF;
                actor->unk_0D4 = 100;
            } else {
...
void func_8006F254(Actor* actor) {
    ...
    func_8007F04C(OBJ_8C_353, actor->obj.pos.x + sp48.x, actor->obj.pos.y + sp48.y, actor->obj.pos.z + sp48.z,
    ...
    if ((gPlayer[0].state_1C8 == PLAYERSTATE_1C8_3) && (actor->unk_0B4 != 0x34) && (actor->unk_0B4 != 0x67) &&
        ...
        switch (actor->unk_048) {
            ...
            case 5:
                ...
                Matrix_MultVec3fNoTranslate(gCalcMatrix, &sp78, &sp6C);
                func_8007F04C(OBJ_8C_355, actor->obj.pos.x + sp6C.x, actor->obj.pos.y + sp6C.y,
            ...
            case 6:
                if (actor->obj.pos.z < (gPlayer[0].unk_138 - 600.0f)) {
                    func_8007F11C(OBJ_8C_355, actor->obj.pos.x, actor->obj.pos.y, actor->obj.pos.z, D_80177828);
                }
                actor->unk_048 = 0;
                break;
            ...
            case 7:
                if (actor->obj.pos.z < (gPlayer[0].unk_138 - 600.0f)) {
                    func_8007F11C(OBJ_8C_356, actor->obj.pos.x, actor->obj.pos.y, actor->obj.pos.z, 60.0f);
                }
                actor->unk_048 = 0;
                break;
            ...
            case 16:
                func_8007F11C(OBJ_8C_353, actor->obj.pos.x + 190.0f, actor->obj.pos.y + 90.0f,
            ...
            case 17:
                if (actor->obj.pos.z < (gPlayer[0].camEye.z - 600.0f)) {
                    func_8007F20C(OBJ_8C_353, actor->obj.pos.x, actor->obj.pos.y, actor->obj.pos.z, D_80177828);
                }
                actor->unk_048 = 0;
                break;
...
void func_8006FEEC(Actor* actor) {
    ...
    if ((actor->unk_0D0 != 0) && (actor->unk_0CE != 0)) {
        actor->unk_0D0 = 0;
        actor->timer_0C6 = 0xF;
        actor->unk_0CE = actor->unk_0CE - actor->unk_0D6;
...
void func_800701E0(Actor* actor) {
    ...
    if (!func_800700A4(actor)) {
        ...
        if ((actor->unk_0D0 != 0) && (actor->unk_0B4 == 0x53) && (actor->timer_0C2 >= 2)) {
            actor->unk_0D0 = 0;
        }

        if ((actor->unk_0D0 != 0) &&
            (((actor->unk_0B4 == 0x40) && (actor->unk_0D2 == 2)) || (actor->unk_0B4 != 0x40))) {
            if (actor->iwork[12] >= 4) {
                actor->unk_0D6 = 0;
            }

            if ((actor->iwork[12] > 0) && (actor->iwork[12] < 4)) {
                gTeamShields[actor->iwork[12]] -= actor->unk_0D6;
            } else if ((actor->unk_0B4 == 0x53) && ((actor->unk_0D6 == 0x1E) || (actor->unk_0D6 == 0x1F))) {
                actor->unk_0CE = 0;
            } else {
            ...
            if (actor->unk_0CE <= 0) {
                ...
                if (actor->unk_0B4 != 0x53) {
                    ...
                    if (((Rand_ZeroOne() < var_fv1) || (actor->iwork[12] != 0)) && (actor->info.unk_14 == 0) &&
                        ...
                        ((s32) actor->unk_0D6 < 0x1F) && (actor->unk_0B4 != 0x3E) && (actor->unk_0B4 != 0x40) &&
...
void func_80070D44(Actor* actor) {
    ...
    switch (actor->iwork[2]) {
        ...
        case 41:
            if ((gActors[actor->iwork[9]].obj.status != 2) ||
                ((gActors[actor->iwork[9]].scale < 0.0f) && (actor->unk_0CE <= 0))) {
                func_80070CEC(actor);
            }
            break;
        ...
        case 46:
            for (i = 0, otherActor = gActors; i < ARRAY_COUNT(gActors); i++, otherActor++) {
                if (((otherActor->obj.status == 3) || (otherActor->obj.status == 0)) &&
            ...
            case 15:
                ...
                if ((actor->unk_0B4 == 0x21) || (actor->unk_0B4 == 0x44)) {
                    ...
                    if (!(actor->timer_0BC & 0x1F) && (spFC == 0)) {
                        ...
                        func_8007F04C(OBJ_8C_353, actor->obj.pos.x + spAC.x + spA0.x,
            ...
            case 80: {
                        ...
                        if ((actor->obj.pos.y + sp90.y) > -30.0f) {
                            for (sp74 = 0; sp74 < 7; sp74++) {
                                ...
                                if (obj8C != NULL) {
                                    ...
                                    obj8C->obj.status = 2;
                                    obj8C->obj.pos.x = actor->obj.pos.x + sp90.x;
                                    obj8C->obj.pos.y = actor->obj.pos.y + sp90.y;
                                    obj8C->obj.pos.z = actor->obj.pos.z;
                ...
                if ((fabsf(actor->fwork[0]) > 10.0f) && !(gFrameCount & 1)) {
                    ...
                    if (obj8C != NULL) {
                        ...
                        obj8C->obj.pos.x = ((Rand_ZeroOne() - 0.5f) * 3.0f) + actor->obj.pos.x + sp90.x;
                        obj8C->obj.pos.y = ((Rand_ZeroOne() - 0.5f) * 3.0f) + actor->obj.pos.y + sp90.y;
                        obj8C->obj.pos.z = ((Rand_ZeroOne() - 0.5f) * 3.0f) + actor->obj.pos.z + 180.0f;
                    ...
                    if (!(gFrameCount & 3)) {
                        ...
                        if (obj8C != NULL) {
                            obj8C->unk_78 = obj8C->unk_7A = 0xB;
                            obj8C->obj.status = 2;
                            obj8C->obj.pos.x = ((Rand_ZeroOne() - 0.5f) * 3.0f) + actor->obj.pos.x;
                            obj8C->obj.pos.y = ((Rand_ZeroOne() - 0.5f) * 5.0f) + actor->obj.pos.y + 50.0f;
                            obj8C->obj.pos.z = ((Rand_ZeroOne() - 0.5f) * 3.0f) + actor->obj.pos.z + 200.0f;
                            obj8C->scale2 = 9.0f;
                            obj8C->obj.rot.z = Rand_ZeroOne() * 360.0f;
                            obj8C->vel.x = (Rand_ZeroOne() - 0.5f) * 5.0f;
...
bool func_80074C44(s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3f* rot, void* data) {
    ...
    if (limbIndex == 5) {
        var_s1 = (s32) (actor->unk_0CE * 0.6375f);
        if (var_s1 > 255) {
            var_s1 = 255;
        }
        if (var_s1 < 0) {
...
void func_80074FF0(Actor* actor) {
    ...
    if ((actor->obj.status == 3) && (actor->timer_0BE != 0)) {
        RCP_SetupDL_27();
        gDPSetPrimColor(gMasterDisp++, 0x00, 0x00, 255, 0, 0, 255);
    }
