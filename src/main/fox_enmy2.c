    ...
    switch (obj80->state) {
        case 0:
            ...
            if (obj80->obj.pos.y < gGroundLevel + 40.0f) {
                ...
                AUDIO_PLAY_SFX(0x19130003, obj80->sfxPos, 0);
                obj80->state = 2;
                obj80->vel.y = 0.0f;
            }
            break;
            ...
            if ((actor->fwork[5] + actor->obj.pos.y) < 0.0f) {
                if (actor->iwork[0] >= 2) {
                    ...
                    if (actor->unk_04A & 4) {
                        switch (actor->unk_046) {
                            case 2:
                                AUDIO_PLAY_SFX(0x19000024, actor->sfxPos, 4);
                                break;
                            case 25:
                                AUDIO_PLAY_SFX(0x29003031, actor->sfxPos, 4);
                                break;
                        }
                    }
...
UnkStruct_D003C D_800D003C[108] = {
    ...
    { D_6023500, D_800CBEC4, 2.0f, 100.0f, 3000.0f, 1, 0, 1, 0, 1.0f, 1 },
    { D_6022DF0, D_800CBE8C, 1.5f, 100.0f, 3000.0f, 1, 0, 1, 0, 1.0f, 1 },
    ...
    { D_60285F0, D_603298C, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { D_600AF70, D_6032904, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { D_6023E30, D_6032970, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { NULL, D_603285C, 2.5f, 100.0f, 3000.0f, 2, 0, 0, 0, 1.0f, 1 },
    { D_6001CE0, D_6032938, 3.0f, 100.0f, 3000.0f, 2, 0, 0, 0, 1.0f, 1 },
    { D_6000840, D_6032954, 1.0f, 100.0f, 3000.0f, 2, 1, 0, 0, 1.0f, 1 },
    { D_6012A40, D_6028254, -2.0f, 2100.0f, 3001.0f, 0, 0, 7, 0, 0.0f, 2 },
    { NULL, D_60280E0, -2.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 3 },
    { D_6009950, D_6032878, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { NULL, D_800CBEC4, 2.0f, 100.0f, 3000.0f, 1, 0, 0, 0, 0.0f, 1 },
    { D_600B2B0, D_6032894, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { D_600A2E0, D_60328B0, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { NULL, D_800CBEFC, 2.0f, 200.0f, 3000.0f, 1, 0, 1, 0, 1.0f, 1 },
    { D_600B830, D_800CBE8C, 1.5f, 100.0f, 3000.0f, 1, 0, 1, 0, 1.0f, 1 },
    { NULL, D_603238C, 1.0f, 500.0f, 3000.0f, 1, 0, 0, 0, 0.0f, 1 },
    { D_6020D20, D_60328CC, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    ...
    { D_600B540, D_60328E8, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    ...
    { D_7000C40, D_800CC0D4, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { D_70010E0, D_800CC0F0, -1.0f, 2100.0f, 3001.0f, 0, 0, 0, 0, 0.0f, 1 },
    { D_7000E80, D_800CC054, 2.5f, 100.0f, 3000.0f, 1, 0, 0, 0, 1.0f, 1 },
    { D_70008F0, D_800CBE8C, -1.0f, 100.0f, 8000.0f, 1, 0, 0, 0, 0.0f, 0 },
    { D_7000280, D_800CC070, -1.0f, 1000.0f, 3000.0f, 1, 0, 0, 0, 0.0f, 0 },
...
void func_8006D36C(Actor* actor) {
    ...
    switch (temp_s1[actor->unk_0E6] & 0xFE00) {
                ...
                for (i = 0; i < 2; i++) {
                    if (D_80176550[i] == 0) {
                        ...
                        if (actor->unk_0B4 == 200) {
                            AUDIO_PLAY_SFX(0x11032049, actor->sfxPos, 4);
                        }
                        break;
                    }
                }
                ...
                switch (D_800D003C[actor->unk_0B4].unk_16) {
                    case 1:
                        if ((gCurrentLevel != LEVEL_SOLAR) && (actor->unk_0B4 != 6) &&
                            ...
                            AUDIO_PLAY_SFX(0x31000011, actor->sfxPos, 4);
                        }
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        AUDIO_PLAY_SFX(0x31012039, actor->sfxPos, 4);
                        break;
                    case 5:
                        AUDIO_PLAY_SFX(0x1900302B, actor->sfxPos, 0);
                        break;
                    case 6:
                        AUDIO_PLAY_SFX(0x31000014, actor->sfxPos, 4);
                        break;
                    case 7:
                        AUDIO_PLAY_SFX(0x31000015, actor->sfxPos, 4);
                        break;
                }
        ...
        case 0xEC00:
            func_8001D400(temp_s1[actor->unk_0E6 + 1]);
            actor->unk_0E6 += 2;
            func_8006D36C(actor);
            break;
        ...
        case 0x7400:
            func_8001D2FC(actor->sfxPos, temp_s1[actor->unk_0E6 + 1]);
            actor->unk_0E6 += 2;
            func_8006D36C(actor);
            break;

        case 0x7600:
            func_8001D3A0(actor->sfxPos, temp_s1[actor->unk_0E6 + 1]);
            actor->unk_0E6 += 2;
            func_8006D36C(actor);
            break;
...
void func_8006EAC4(Effect* effect, f32 xPos, f32 yPos, f32 zPos) {
    ...
    effect->timer_50 = 20;
    Object_SetInfo(&effect->info, effect->obj.id);
    AUDIO_PLAY_SFX(0x2900201D, effect->sfxPos, 4);
}
...
void func_8006ECBC(PlayerShotId objId, PlayerShot* shot, s32 unk0E4, f32 xPos, f32 yPos, f32 zPos, f32 arg6, f32 arg7,
    ...
    if (gLevelMode == LEVELMODE_ALL_RANGE) {
        if (unk0E4 + 100 < 104) {
            AUDIO_PLAY_SFX(0x2900000D, shot->sfxPos, 4);
        } else {
            AUDIO_PLAY_SFX(0x29002002, shot->sfxPos, 4);
        }
    } else if ((unk0E4 < 60) && (gActors[unk0E4].obj.id == OBJ_ACTOR_200) && (gActors[unk0E4].iwork[12] > 0)) {
        AUDIO_PLAY_SFX(0x2900000D, shot->sfxPos, 4);
    } else if (unk0E4 + 100 == 200) {
        shot->playerNum = 100;
        AUDIO_PLAY_SFX(0x19030037, shot->sfxPos, 0);
    } else {
        AUDIO_PLAY_SFX(0x29002002, shot->sfxPos, 4);
    }
}
...
void func_8006FEEC(Actor* actor) {
    ...
    if ((actor->unk_0D0 != 0) && (actor->health != 0)) {
        ...
        if (actor->health <= 0) {
            ...
            AUDIO_PLAY_SFX(0x29033037, actor->sfxPos, 4);
        }
    }
}
            ...
            if (actor->health <= 0) {
                ...
                if (actor->unk_0B4 != 83) {
                    if ((actor->unk_0B4 == 6) && (gCurrentLevel == LEVEL_SOLAR)) {
                        AUDIO_PLAY_SFX(0x29018036, actor->sfxPos, 4);
                    } else {
                        AUDIO_PLAY_SFX(0x2903700B, actor->sfxPos, 4);
                    }
                ...
                if (actor->unk_0B4 == 0x52) {
                    AUDIO_PLAY_SFX(0x11000055, actor->sfxPos, 0);
                    actor->unk_0D0 = 1;
    ...
    if (actor->unk_0D0 != 0) {
        ...
        if ((actor->unk_0B4 != 17) || ((actor->unk_0B4 == 17) && (actor->unk_0D2 == 0))) {
            ...
            func_8007C120(actor->unk_0D8.x, actor->unk_0D8.y, actor->unk_0D8.z, actor->vel.x, actor->vel.y,
                          actor->vel.z, 0.2f, 10);
            actor->health -= actor->damage;
            AUDIO_PLAY_SFX(0x29033064, actor->sfxPos, 4);
            if (actor->health <= 0) {
        ...
        case 0:
            if (actor->unk_0D0 != 0) {
                ...
                if (actor->health <= 0) {
                    ...
                    AUDIO_PLAY_SFX(0x1900000D, actor->sfxPos, 0);
                } else {
                    AUDIO_PLAY_SFX(0x2903300E, actor->sfxPos, 0);
                }
                actor->unk_0D0 = 0;
            }
            break;
    ...
    if (actor->state == 0x3E8) {
        ...
        if (actor->unk_0B4 == 300) {
            ...
            if (actor->unk_0D0 != 0) {
                ...
                AUDIO_PLAY_SFX(0x29034041, actor->sfxPos, 4);
            ...
            if (actor->scale <= -1.999f) {
                ...
                if ((actor->unk_0D0 == 1) && (actor->scale < 0.5f) && (actor->unk_0B4 != 0x30) &&
                    ...
                    if (gCurrentLevel == LEVEL_METEO) {
                        AUDIO_PLAY_SFX(0x2902107D, actor->sfxPos, 4);
                    } else {
                        AUDIO_PLAY_SFX(0x29121007, actor->sfxPos, 4);
                    }
                }
                ...
                if (func_800A73E4(&spEC, &spFC, actor->obj.pos.x, -100.0f, actor->obj.pos.z)) {
                    ...
                    if (Math_SmoothStepToF(&actor->obj.pos.y, spEC, 0.5f, 7.0f, 0.0f) >= 0.0f) {
                        ...
                        if (!(gGameFrameCount & 3)) {
                            ...
                            AUDIO_PLAY_SFX(0x19800017, actor->sfxPos, 4);
                        }
                    }
...
void func_80074E3C(Actor* actor) {
    ...
    Animation_DrawSkeleton(1, D_601390C, sp30, func_80074C44, NULL, actor, &gIdentityMatrix);
}
    ...
    switch (actor->unk_0B4) {
        ...
        default:
            ...
            switch (actor->unk_0B4) {
                ...
                case 36:
                    Animation_GetFrameData(&D_700CAF4, actor->unk_0B6, sp114);
                    sp114[2].z += actor->fwork[15];
                    Animation_DrawSkeleton(1, D_700CB60, sp114, NULL, NULL, actor, &gIdentityMatrix);
                    break;
                ...
                case 83:
                    ...
                    Animation_GetFrameData(&D_602201C, actor->unk_0B6, sp114);
                    Animation_DrawSkeleton(1, D_60220E8, sp114, NULL, NULL, actor, &gIdentityMatrix);
                    break;
