...
void func_800444BC(Player* player) {
    ...
    if ((player->pos.y - sp30) < sp38) {
        if (player->vel.y < -10.0f) {
            AUDIO_PLAY_SFX(0x09008015, player->sfxPos, 0);
        }
        player->unk_1D4 = 1;
        if (player->vel.y < -20.0f) {
            player->unk_1F4 = 20;
...
void func_80045130(Player* player) {
    ...
    if (gInputPress->button & Z_TRIG) {
        ...
        if ((player->timer_1E0 != 0) && (player->unk_12C > 0.0f) && (player->unk_2BC < 10.0f)) {
            ...
            player->unk_1EC = 20;
            player->unk_494 = 1;
            AUDIO_PLAY_SFX(0x1100000A, player->sfxPos, 0);
        } else {
            player->timer_1E0 = 10;
        }
    }
    ...
    if (player->unk_19C >= 0) {
        if ((gBoostButton[player->num] & gInputHold->button) && !player->unk_2B4) {
            ...
            if (D_800C9F24 == 0.0f) {
                ...
                AUDIO_PLAY_SFX(0x0900402F, player->sfxPos, 0);
            } else {
                player->unk_190 = 2.0f;
            }
            sp44 = 25.0f;
...
void func_80045678(Player* player) {
    ...
    if ((gInputHold->button & Z_TRIG) && !player->unk_2B4) {
        D_800C9F14++;
        if (D_800C9F20 == 0.0f) {
            AUDIO_PLAY_SFX(0x01004024, player->sfxPos, 0);
        }
        player->unk_188 = 0.0f;
        player->unk_12C += 4.0f;
    ...
    if (!(D_800C9F08 & 1)) {
        ...
        if (player->unk_0EC >= 3.0f) {
            if (gPlayer[0].state_1C8 != PLAYERSTATE_1C8_7) {
                AUDIO_PLAY_SFX(0x19000065, player->sfxPos, 0);
            }
            D_800C9F08 |= 1;
        }
    } else {
                ...
                if (temp_v0 != 0) {
                    if (temp_v0 < 0) {
                        if (temp_v0 == -1) {
                            ...
                            player->unk_23C = 80;
                            if (player->unk_22C == 0) {
                                AUDIO_PLAY_SFX(0x19000001, player->sfxPos, 0);
                            }
                            player->unk_22C += 2;
                            if (player->unk_22C >= 4) {
                                player->unk_22C = 4;
