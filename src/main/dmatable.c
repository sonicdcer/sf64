...
DmaEntry gDmaTable[90] = {
    ...
    { SEGMENT_ROM_START(ast_landmaster), { SEGMENT_ROM_START(ast_landmaster), SEGMENT_ROM_END(ast_landmaster) }, false },
    { SEGMENT_ROM_START(ast_blue_marine), { SEGMENT_ROM_START(ast_blue_marine), SEGMENT_ROM_END(ast_blue_marine) }, false },
    { SEGMENT_ROM_START(ast_vs_player), { SEGMENT_ROM_START(ast_vs_player), SEGMENT_ROM_END(ast_vs_player) }, false },
    { SEGMENT_ROM_START(ast_enmy_planet), { SEGMENT_ROM_START(ast_enmy_planet), SEGMENT_ROM_END(ast_enmy_planet) }, false },
    { SEGMENT_ROM_START(ast_enmy_space), { SEGMENT_ROM_START(ast_enmy_space), SEGMENT_ROM_END(ast_enmy_space) }, false },
    ...
    { SEGMENT_ROM_START(ast_ending_award_front), { SEGMENT_ROM_START(ast_ending_award_front), SEGMENT_ROM_END(ast_ending_award_front) }, false },
    { SEGMENT_ROM_START(ast_ending_award_back), { SEGMENT_ROM_START(ast_ending_award_back), SEGMENT_ROM_END(ast_ending_award_back) }, false },
