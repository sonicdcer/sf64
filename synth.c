...
s32 *func_8000A25C(s32 arg0, s32 arg1, s32 *arg2, s16 arg3); /* static */
...
void *func_8000B480(s32 *arg0, NoteSynthesisState *arg1, s32 arg2, u16 arg3, s32 arg4, u32 arg5); /* static */
s32 *func_8000B51C(void *arg0, NoteSubEu *arg1, NoteSynthesisState *arg2, s32 arg3, u16 arg4, s32 arg5, u32); /* static */
s32 *func_8000B98C(s32 *arg0, NoteSubEu *arg1, NoteSynthesisState *arg2, s32 arg3, u32 arg4, s32 arg5); /* static */
extern ? D_800DD200;
    ...
    default:
        if (var_s7 != (s32) *arg2) {
            ...
            *arg2 = temp_fv0_2;
            ...
            temp_v0 = &arg2[sp58];
            temp_v1 = &temp_v0[sp58];
            var_s1 = temp_v0 + 4;
            var_s2 = temp_v1 + 4;
            var_s3 = &temp_v1[sp58] + 4;
            var_fs0 = temp_fv1_4;
            if (sp58 > 0) {
                sp50 = temp_fv1_4;
                do {
...
loop_13:
                ...
                if (var_a1 < sp5C) {
                    ...
                    do {
                        temp_a0 = &arg0[var_a1];
                        temp_ra = &temp_a0[temp_t8_2];
                        temp_v0_2 = &temp_ra[temp_t8_2];
                        D_80146D54 = *temp_a0;
                        temp_v1_2 = &temp_v0_2[temp_t8_2];
                        ...
                        *temp_v1_2 += (D_80146D54 - D_80146D5C) - D_80146D58;
                        ...
                        if (sp50 >= 2) {
                            ...
                            *temp_a0_2 = (D_80146D58 - *temp_a0_2) * 1.414214f;
                            var_s0_2 = &arg2[spC0];
                            var_s1_2 = &var_s0_2[sp58];
                            var_s2_2 = &var_s1_2[sp58];
                            var_s3_2 = &var_s2_2[sp58];
                            spC8 = 1;
                            if (sp4C >= 2) {
                                do {
                                    temp_v0_5 = &sp48[spC8];
        ...
        if (var_s7 >= 2) {
            ...
            do {
                ...
                if (temp_t0 < var_a1_2) {
                    do {
                        var_a1_2 -= var_v0_3;
                        temp_t8_3 = var_v0_3 >> 1;
                        var_v0_3 = temp_t8_3;
                    } while (temp_t8_3 < var_a1_2);
                }
                var_a3_4 += 1;
                var_a1_2 += var_v0_3;
...
u8 *func_800097A8(void *arg0, s32 arg1, u32 arg2, s16 *arg3) {
    SampleDma *sp1C;
    ...
    if (arg2 == 1) {
        ...
        if (gSampleDmaReuseQueue1WrPos != gSampleDmaReuseQueue1RdPos) {
            arg3->unk14 = &gSampleDmas[gSampleDmaReuseQueue1[gSampleDmaReuseQueue1RdPos]];
...
void func_80009A2C(s32 arg0, s32 arg1) {
    ...
    var_v0 = arg0 + 1;
    if (var_v0 < gAudioBufferParams.ticksPerUpdate) {
loop_2:
        temp_a0 = &(&gNoteSubsEu[gNumNotes * var_v0])[arg1];
...
void func_80009AAC(s32 arg0) {
    ...
    if (gNumNotes > 0) {
        do {
            ...
            var_v0 += 1;
            var_a1 += 0xC0;
        } while (var_v0 < gNumNotes);
    }
}

s32 *func_80009B64(s32 *arg0, s32 *arg1, s32 arg2, s16 arg3) {
    ...
    var_s4 = gAudioBufferParams.ticksPerUpdate;
    var_s5 = arg3;
    var_fp = arg0;
    if (var_s4 > 0) {
        do {
            ...
            func_80009AAC(gAudioBufferParams.ticksPerUpdate - var_s4);
            var_s4 = temp_s0;
        } while (temp_s0 > 0);
        var_s4 = gAudioBufferParams.ticksPerUpdate;
    }
    ...
    if (var_s4 > 0) {
        do {
            temp_s2 = gAudioBufferParams.ticksPerUpdate;
            var_s1 = 0;
            if (var_s4 == 1) {
                var_s3 = var_s5;
            } else {
                temp_lo = var_s5 / var_s4;
                if (temp_lo >= gAudioBufferParams.samplesPerTickMax) {
                    var_s3 = gAudioBufferParams.samplesPerTickMax;
                } else if (gAudioBufferParams.samplesPerTickMin >= temp_lo) {
                    var_s3 = gAudioBufferParams.samplesPerTickMin;
                } else {
                    var_s3 = gAudioBufferParams.samplesPerTick;
                }
            }
            temp_v0 = gNumSynthReverbs;
            if (temp_v0 > 0) {
                var_s0 = gSynthReverbs;
                do {
            ...
            temp_v0_2 = func_8000A25C(var_s7, (s32) var_s3, var_fp, temp_s2 - var_s4);
            var_s4 -= 1;
            var_fp = temp_v0_2;
            var_s5 -= var_s3;
            var_s7 += var_s3 * 4;
    ...
    var_s0_2 = gSynthReverbs;
    if (gNumSynthReverbs > 0) {
        do {
            temp_v0_3 = var_s0_2->framesToIgnore;
            if (temp_v0_3 != 0) {
                var_s0_2->framesToIgnore = temp_v0_3 - 1;
            }
            temp_t2 = var_s0_2->curFrame;
            var_s0_2 += 0x1D4;
            var_s0_2->unk-1D1 = (s8) (temp_t2 ^ 1);
        } while ((u32) var_s0_2 < (u32) &gSynthReverbs[gNumSynthReverbs]);
    }
...
s32 *func_8000A25C(s32 arg0, s32 arg1, s32 *arg2, s16 arg3) {
    ? sp84;
    ...
    if (gNumSynthReverbs == 0) {
        var_s1 = 0;
        if (gNumNotes > 0) {
            var_v0 = &gNoteSubsEu[gNumNotes * arg3];
            do {
                temp_t4 = &sp84 + var_s2;
            ...
            do {
                ...
                if (gNumNotes > 0) {
                    ...
                    do {
                        ...
                        var_s1_2 += 1;
                        var_v1 += 1;
                    } while (var_s1_2 < gNumNotes);
                }
                var_s3 += 1;
            } while (var_s3 < gNumSynthReverbs);
            var_s3 = 0;
        }
        var_s1 = 0;
        if (gNumNotes > 0) {
            var_v1_2 = gNumNotes * arg3;
            do {
                temp_v0_2 = &gNoteSubsEu[var_v1_2];
                if (((u32) temp_v0_2->unk0 >> 0x1F) != 0) {
                    temp_t8 = &sp84 + var_s2;
                    if ((s32) ((u8) temp_v0_2->unk1 >> 5) >= gNumSynthReverbs) {
                        var_s2 += 1;
                        *temp_t8 = var_s1;
                    }
                }
...
loop_31:
                temp_v0_3 = *var_s0;
                temp_lo = arg3 * gNumNotes;
                if (var_s3 == ((u8) (&gNoteSubsEu[temp_v0_3])[temp_lo].unk1 >> 5)) {
                    var_s1 += 1;
                    var_s4 = func_8000A700(temp_v0_3, &gNoteSubsEu[temp_v0_3 + temp_lo], &gNotes[temp_v0_3].synthesisState, arg0, arg1, var_s4, (s32) arg3);
                    var_s0 += 1;
                    if (var_s1 < var_s2) {
                        goto loop_31;
                    }
    ...
    if (var_s1 < var_s2) {
        ...
        do {
            temp_v0_4 = *var_s0_2;
            var_s0_2 += 1;
            var_s4 = func_8000A700(temp_v0_4, &gNoteSubsEu[temp_v0_4 + (arg3 * gNumNotes)], &gNotes[temp_v0_4].synthesisState, arg0, arg1, var_s4, (s32) arg3);
    ...
    temp_s4->unk0 = ((((s32) (temp_t3_2 * 2) >> 4) & 0xFF) << 0x10) | 0x15000000 | 0x450;
...
block_46:
                    if (var_s3 != 0) {
                        ...
                        if (temp_t8 == 0) {
                            ...
                            spC0 = var_t2;
                            var_s0_2 = ((var_s3 * var_s7) + 0x1F) & ~0xF;
                            var_a0_2 = AudioLoad_DmaSampleData(sp84 + (temp_t7_3 * var_s7) + spCC, var_s0_2, spF4, &arg2->sampleDmaIndex, (s32) temp_t8);
                        }
                        var_a2 = (s32) var_a0_2 & 0xF;
                        var_s1_2->unk4 = (s32) ((var_a0_2 - var_a2) + 0x80000000);
                        var_s1_2->unk0 = ((((s32) var_s0_2 >> 4) & 0xFF) << 0x10) | 0x14000000 | ((0x990 - var_s0_2) & 0xFFFF);
                        var_s1_2 += 8;
                    } else {
                        var_s2 = 0;
                        var_a2 = 0;
                    ...
                    if (var_t2 == 0) {
                        ...
                        case 0:                     /* switch 2 */
                            ...
                            temp_v1_5->unk0 = ((spF4 & 0xFF) << 0x10) | 0x01000000;
                        ...
                        case 1:                     /* switch 2 */
                            ...
                            temp_v1_6->unk0 = ((spF4 & 0xFF) << 0x10) | 0x17000000;
                        ...
                        if (temp_t9_2 != 0) {
                            if (temp_t9_2 != 1) {
                                ...
                                temp_a0_3->unk0 = ((spF4 & 0xFF) << 0x10) | 0x17000000;
                            ...
                            temp_a0_4->unk0 = ((spF4 & 0xFF) << 0x10) | 0x01000000;
...
s32 *func_8000B3F0(s32 *arg0, NoteSubEu *arg1, NoteSynthesisState *arg2, s32 arg3) {
    ...
    arg0->unk4 = (s32) (arg1->waveSampleAddr + 0x80000000);
    var_a0 = arg0 + 8;
...
void *func_8000B480(s32 *arg0, NoteSynthesisState *arg1, s32 arg2, u16 arg3, u16 arg4, u32 arg5) {
    s32 temp_t6;
    void *temp_a0;
...
s32 *func_8000B98C(s32 *arg0, NoteSubEu *arg1, NoteSynthesisState *arg2, s32 arg3, u32 arg4, s32 arg5) {
    s32 temp_t1;
    s32 temp_v0;
    s32 var_t0;
    s32 var_v1_2;
