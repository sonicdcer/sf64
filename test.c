...
void func_E16C50_8019A5D4(Object_2F4 *arg0) {
    ...
    case 2:
        if ((*(sZoSwork + 0x20) == 0) && (gBosses->unk_04E == 8)) {
            ...
            sp48 = temp_fv0_2;
            sp4C = temp_fa1;
            func_E16C50_8019A4E0((bitwise void *) sZoFwork.unk_104.z, temp_fa1, (bitwise f32) arg0, sZoFwork.unk_104.x, sZoFwork.unk_104.y - (sqrtf(temp_ft2 + (temp_fv0_2 * temp_fv0_2)) * 0.5f), sZoFwork.unk_104.z, 30.0f);
            var_fa1 = temp_fa1;
            arg0->vel.z -= D_80177D08;
        }
        sp4C = var_fa1;
